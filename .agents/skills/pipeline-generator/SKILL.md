...
node script/pipeline/generator-coordinator.js --all --count=10

# Generate specific types in parallel
node script/pipeline/generator-coordinator.js --types=question,challenge --count=5

# Generate with custom options
node script/pipeline/generator-coordinator.js --types=question --channel=react --difficulty=advanced
```

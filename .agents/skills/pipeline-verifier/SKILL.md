...
node script/pipeline/verifier-coordinator.js --status=pending

# Validate specific type
node script/pipeline/verifier-coordinator.js --type=question --limit=100

# Strict validation
node script/pipeline/verifier-coordinator.js --all --strict
```

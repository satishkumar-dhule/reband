...
node script/pipeline/processor-coordinator.js --status=validated

# Process specific type
node script/pipeline/processor-coordinator.js --type=flashcard --batch=50

# Full pipeline (generate -> verify -> process)
node script/pipeline/full-pipeline.js --count=10
```

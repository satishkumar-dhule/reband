...
> ⚠️ **Deprecation Notice**: This skill is for Replit-specific design work only. For DevPrep/Open-Interview, use the GitHub theme skills (github-theme-migration, github-theme-components) instead, as this project follows GitHub's design system rather than Replit's.

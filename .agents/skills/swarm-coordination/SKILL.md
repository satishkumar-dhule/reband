...
| Conflicting results     | Document both views for manual resolution |
...
**Before starting:** Review any existing learnings and decisions in the project memory files.

**After completing:** Document new patterns, issues found, and decisions made to appropriate project memory locations.

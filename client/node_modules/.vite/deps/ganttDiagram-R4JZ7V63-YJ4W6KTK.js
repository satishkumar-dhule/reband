...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/ganttDiagram-R4JZ7V63.mjs
...
var require_customParseFormat = __commonJS({
  "../../node_modules/.pnpm/dayjs@1.11.19/node_modules/dayjs/plugin/customParseFormat.js"(exports, module) {
    ...
    !(function(e, t) {
      ...
      "use strict";
      var e = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, t = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|Q|YYYY|YY?|ww?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, n = /\d/, r = /\d\d/, i = /\d\d?/, o = /\d*[^-_:/,()\s\d]+/, s = {}, a = __name(function(e2) {
      ...
      }], u = __name(function(e2) {
        var t2 = s[e2];
        return t2 && (t2.indexOf ? t2 : t2.s.concat(t2.f));
      }, "u"), d = __name(function(e2, t2) {
...
var require_duration = __commonJS({
  "../../node_modules/.pnpm/dayjs@1.11.19/node_modules/dayjs/plugin/duration.js"(exports, module) {
    ...
    !(function(t, s) {
      ...
      "use strict";
      var t, s, n = 1e3, i = 6e4, e = 36e5, r = 864e5, o = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, u = 31536e6, d = 2628e6, a = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, h = { years: u, months: d, days: r, hours: e, minutes: i, seconds: n, milliseconds: 1, weeks: 6048e5 }, c = __name(function(t2) {
        return t2 instanceof g;
      }, "c"), f = __name(function(t2, s2, n2) {
        return new g(t2, n2, s2.$l);
      }, "f"), m = __name(function(t2) {
        return s.p(t2) + "s";
      }, "m"), l = __name(function(t2) {
        return t2 < 0;
      }, "l"), $ = __name(function(t2) {
        return l(t2) ? Math.ceil(t2) : Math.floor(t2);
      }, "$"), y = __name(function(t2) {
        return Math.abs(t2);
      }, "y"), v = __name(function(t2, s2) {
...
var draw = __name(function(text, id, version, diagObj) {
  ...
  if (securityLevel === "sandbox") {
    sandboxElement = select_default2("#i" + id);
  }
  const root = securityLevel === "sandbox" ? select_default2(sandboxElement.nodes()[0].contentDocument.body) : select_default2("body");
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    if (securityLevel2 === "sandbox") {
      let sandboxElement2;
      sandboxElement2 = select_default2("#i" + id);
...
//# sourceMappingURL=ganttDiagram-R4JZ7V63-YJ4W6KTK.js.map

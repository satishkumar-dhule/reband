...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/sankeyDiagram-5FSKPGKG.mjs
var parser = (function() {
...
Path.prototype = path.prototype = {
  ...
  quadraticCurveTo: __name(function(x1, y1, x2, y2) {
    this._ += "Q" + +x1 + "," + +y1 + "," + (this._x1 = +x2) + "," + (this._y1 = +y2);
  }, "quadraticCurveTo"),
  bezierCurveTo: __name(function(x1, y1, x2, y2, x3, y3) {
    this._ += "C" + +x1 + "," + +y1 + "," + +x2 + "," + +y2 + "," + (this._x1 = +x3) + "," + (this._y1 = +y3);
  }, "bezierCurveTo"),
  arcTo: __name(function(x1, y1, x2, y2, r) {
  ...
  arc: __name(function(x2, y2, r, a0, a1, ccw) {
  ...
  rect: __name(function(x2, y2, w, h) {
...
function constant_default(x2) {
  return __name(function constant2() {
    return x2;
  }, "constant");
}
...
var draw = __name(function(text, id, _version, diagObj) {
  ...
  const svg = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : select_default2(`[id="${id}"]`);
...
//# sourceMappingURL=sankeyDiagram-5FSKPGKG-4BP5ZT3G.js.map

import {
  populateCommonDb
} from "./chunk-R746AVZX.js";
import {
  parse
} from "./chunk-4QDRNKUB.js";
import "./chunk-NKBALMEA.js";
import "./chunk-YMRMR3WA.js";
import "./chunk-5JDDBR2P.js";
import "./chunk-QWHPWXTJ.js";
import "./chunk-G32HPABH.js";
import "./chunk-MNGL3BM7.js";
import "./chunk-GARU6ZET.js";
import "./chunk-WUIJBLYA.js";
import "./chunk-M3JE5CQE.js";
import {
  cytoscape as cytoscape2
} from "./chunk-Z4HNZR3K.js";
import {
  selectSvgElement
} from "./chunk-5MUN6RSQ.js";
import "./chunk-WT5MOA24.js";
import {
  createText,
  getIconSVG,
  registerIconPacks,
  unknownIcon
} from "./chunk-LHBCKCSD.js";
import {
  cleanAndMerge,
  getEdgeId
} from "./chunk-3QERH4HY.js";
import "./chunk-2OESXAI4.js";
import {
  clear,
  ...
  setDiagramTitle,
  setupGraphViewbox
} from "./chunk-KT5MN6BN.js";
import "./chunk-XWGXU2JD.js";
import {
  log,
  select_default2
} from "./chunk-WAFFMA3Z.js";
import {
  __commonJS,
  __name,
  __toESM
...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/architectureDiagram-T4ORD67E.mjs
var require_layout_base = __commonJS({
  "../../node_modules/.pnpm/layout-base@2.0.1/node_modules/layout-base/layout-base.js"(exports, module) {
    "use strict";
    __name((function webpackUniversalModuleDefinition(root, factory) {
        ...
        (function(modules) {
          ...
          __webpack_require__.n = function(module2) {
            var getter = module2 && module2.__esModule ? (
              /******/
              __name(function getDefault() {
                return module2["default"];
              }, "getDefault")
            ) : (
              /******/
              __name(function getModuleExports() {
                return module2;
              }, "getModuleExports")
            );
          ...
          (function(module2, exports2, __webpack_require__) {
            ...
            var nodeFrom = __name(function nodeFrom2(value) {
              return { value, next: null, prev: null };
            }, "nodeFrom");
            var add = __name(function add2(prev, node, next2, list) {
              if (prev !== null) {
                prev.next = node;
              } else {
                list.head = node;
            ...
            var _remove = __name(function _remove2(node, list) {
            ...
            var LinkedList = (function() {
              ...
              _createClass(LinkedList2, [{
                key: "size",
                value: __name(function size() {
                  return this.length;
                }, "size")
              }, {
                key: "insertBefore",
                value: __name(function insertBefore(val, otherNode) {
                  return add(otherNode.prev, nodeFrom(val), otherNode, this);
                }, "insertBefore")
              }, {
                key: "insertAfter",
                value: __name(function insertAfter(val, otherNode) {
                  return add(otherNode, nodeFrom(val), otherNode.next, this);
                }, "insertAfter")
              }, {
                key: "insertNodeBefore",
                value: __name(function insertNodeBefore(newNode, otherNode) {
                  return add(otherNode.prev, newNode, otherNode, this);
                }, "insertNodeBefore")
              }, {
                key: "insertNodeAfter",
                value: __name(function insertNodeAfter(newNode, otherNode) {
                  return add(otherNode, newNode, otherNode.next, this);
                }, "insertNodeAfter")
              }, {
                key: "push",
                value: __name(function push(val) {
                  return add(this.tail, nodeFrom(val), null, this);
                }, "push")
              }, {
                key: "unshift",
                value: __name(function unshift(val) {
                  return add(null, nodeFrom(val), this.head, this);
                }, "unshift")
              }, {
                key: "remove",
                value: __name(function remove(node) {
                  return _remove(node, this);
                }, "remove")
              }, {
                key: "pop",
                value: __name(function pop() {
                  return _remove(this.tail, this).value;
                }, "pop")
              }, {
                key: "popNode",
                value: __name(function popNode() {
                  return _remove(this.tail, this);
                }, "popNode")
              }, {
                key: "shift",
                value: __name(function shift() {
                  return _remove(this.head, this).value;
                }, "shift")
              }, {
                key: "shiftNode",
                value: __name(function shiftNode() {
                  return _remove(this.head, this);
                }, "shiftNode")
              }, {
                key: "get_object_at",
                value: __name(function get_object_at(index) {
                ...
                key: "set_object_at",
                value: __name(function set_object_at(index, value) {
                  if (index <= this.length()) {
                    var i = 1;
                    var current = this.head;
                    while (i < index) {
          ...
          (function(module2, exports2, __webpack_require__) {
            ...
            var Quicksort = (function() {
              ...
              _createClass(Quicksort2, [{
                key: "_quicksort",
                value: __name(function _quicksort(A, p, r) {
                  if (p < r) {
                ...
                key: "_partition",
                value: __name(function _partition(A, p, r) {
                  var x = this._get(A, p);
                  var i = p;
                  var j = r;
                  while (true) {
                ...
                value: __name(function _defaultCompareFunction(a, b) {
                  return b > a;
          ...
          (function(module2, exports2, __webpack_require__) {
            ...
            SVD.svd = function(A) {
              ...
              this.U = (function(dims) {
                var allocate = __name(function allocate2(dims2) {
                  if (dims2.length == 0) {
                    return 0;
                  } else {
                    var array = [];
          ...
          (function(module2, exports2, __webpack_require__) {
            ...
            var NeedlemanWunsch = (function() {
              ...
              _createClass(NeedlemanWunsch2, [{
                key: "getScore",
                value: __name(function getScore() {
                  return this.score;
                }, "getScore")
              }, {
                key: "getAlignments",
                value: __name(function getAlignments2() {
                  return this.alignments;
                }, "getAlignments")
                // Main dynamic programming procedure
              }, {
                key: "computeGrids",
                value: __name(function computeGrids() {
                ...
                value: __name(function alignmentTraceback() {
                ...
                key: "getAllIndexes",
                value: __name(function getAllIndexes(arr, val) {
                  var indexes = [], i = -1;
                ...
                value: __name(function arrayAllMaxIndexes(array) {
          ...
          (function(module2, exports2, __webpack_require__) {
            "use strict";
            var layoutBase = __name(function layoutBase2() {
              return;
            }, "layoutBase");
            ...
            765: (
              ...
              ((module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                CoSELayout.prototype.initConstraintVariables = function() {
                  ...
                  var calculateCompoundWeight = __name(function calculateCompoundWeight2(compoundNode) {
                  ...
                  if (this.constraints.relativePlacementConstraint) {
                    ...
                    if (CoSEConstants.RELAX_MOVEMENT_ON_CONSTRAINTS) {
                      ...
                      var constructComponents = __name(function constructComponents2(graph, fixedNodes) {
                        var components = [];
                        var isFixed = [];
                        var queue = new LinkedList();
                        var visited = /* @__PURE__ */ new Set();
                ...
                CoSELayout.prototype.tileNodesByFavoringDim = function(nodes, minWidth, favorHorizontalDim) {
                  ...
                  var getNodeArea = __name(function getNodeArea2(n) {
                    return n.rect.width * n.rect.height;
                  }, "getNodeArea");
                  var areaCompareFcn = __name(function areaCompareFcn2(n1, n2) {
            ...
            902: (
              ...
              ((module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                ConstraintHandler.handleConstraints = function(layout) {
                  ...
                  var calculatePositionDiff = __name(function calculatePositionDiff2(pos1, pos2) {
                    return { x: pos1.x - pos2.x, y: pos1.y - pos2.y };
                  }, "calculatePositionDiff");
                  var calculateAvgPosition = __name(function calculateAvgPosition2(nodeIdSet) {
                    var xPosSum = 0;
                    var yPosSum = 0;
                  ...
                  var findAppropriatePositionForRelativePlacement = __name(function findAppropriatePositionForRelativePlacement2(graph, direction, fixedNodes2, dummyPositions, componentSources) {
                  ...
                  var applyReflectionForRelativePlacement = __name(function applyReflectionForRelativePlacement2(relativePlacementConstraints) {
                  ...
                  var findComponents = __name(function findComponents2(graph) {
                    var components2 = [];
                    var queue = new LinkedList();
                    var visited = /* @__PURE__ */ new Set();
                    var count = 0;
                  ...
                  var dagToUndirected = __name(function dagToUndirected2(dag2) {
                  ...
                  var dagToReversed = __name(function dagToReversed2(dag2) {
                    ...
                    if (constraints.fixedNodeConstraint && constraints.fixedNodeConstraint.length > 1) {
                      ...
                      (function() {
                        ...
                        if (constraints.alignmentConstraint.vertical) {
                          ...
                          var _loop2 = __name(function _loop22(_i42) {
                        ...
                        if (constraints.alignmentConstraint.horizontal) {
                          ...
                          var _loop3 = __name(function _loop32(_i52) {
                            var alignmentSet = /* @__PURE__ */ new Set();
                  ...
                  if (CoSEConstants.ENFORCE_CONSTRAINTS) {
                    ...
                    if (constraints.alignmentConstraint) {
                      if (constraints.alignmentConstraint.vertical) {
                        ...
                        var _loop4 = __name(function _loop42(_i92) {
                          var alignmentSet = /* @__PURE__ */ new Set();
                      ...
                      if (constraints.alignmentConstraint.horizontal) {
                        ...
                        var _loop5 = __name(function _loop52(_i102) {
                          var alignmentSet = /* @__PURE__ */ new Set();
                      ...
                      (function() {
                        ...
                        if (constraints.alignmentConstraint) {
                          if (constraints.alignmentConstraint.vertical) {
                            ...
                            var _loop6 = __name(function _loop62(_i112) {
                          ...
                          if (constraints.alignmentConstraint.horizontal) {
                            ...
                            var _loop7 = __name(function _loop72(_i122) {
                        ...
                        var _loop8 = __name(function _loop82(nodeId2) {
                        ...
                        var _loop9 = __name(function _loop92(key2) {
                        ...
                        var _loop10 = __name(function _loop102(key2) {
          ...
          var __webpack_modules__ = {
              ...
              ((module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                auxiliary.connectComponents = function(cy, eles, topMostNodes, dummyNodes) {
                  ...
                  var _loop = __name(function _loop2() {
                    ...
                    var _loop22 = __name(function _loop23() {
                      currentNode = queue.shift();
            ...
            816: (
              ...
              ((module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                var coseLayout = __name(function coseLayout2(options, spectralResult) {
                  var cy = options.cy;
                  ...
                  var isFn = __name(function isFn2(fn) {
                    return typeof fn === "function";
                  }, "isFn");
                  var optFn = __name(function optFn2(opt, ele) {
                    if (isFn(opt)) {
                      return opt(ele);
                    } else {
                      return opt;
                  ...
                  var processChildrenList = __name(function processChildrenList2(parent, children, layout, options2) {
                  ...
                  var processEdges = __name(function processEdges2(layout, gm2, edges2) {
                  ...
                  var processConstraints = __name(function processConstraints2(layout, options2) {
                ...
                var Layout2 = (function() {
                  ...
                  _createClass(Layout3, [{
                    ...
                    value: __name(function run() {
                      ...
                      var getPositions = __name(function getPositions2(ele, i2) {
                        if (options.quality == "default" || options.quality == "proof") {
                          if (typeof ele === "number") {
                            ele = i2;
                          }
            ...
            657: (
              ...
              ((module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                var spectralLayout = __name(function spectralLayout2(options) {
                  var cy = options.cy;
                  var eles = options.eles;
                  var nodes = eles.nodes();
                  ...
                  var randomSampleCR = __name(function randomSampleCR2() {
                    var sample2 = 0;
                    var count = 0;
                    var flag = false;
                  ...
                  var BFS = __name(function BFS2(pivot, index2, samplingMethod) {
                    var path = [];
                    var front = 0;
                    var back = 0;
                    var current = 0;
                  ...
                  var allBFS = __name(function allBFS2(samplingMethod) {
                    var sample2 = void 0;
                    if (!samplingMethod) {
                      randomSampleCR();
                  ...
                  var sample = __name(function sample2() {
                  ...
                  var powerIteration = __name(function powerIteration2() {
                    var theta1 = void 0;
                    var theta2 = void 0;
                    var Y1 = [];
                    var Y2 = [];
                  ...
                  var _loop = __name(function _loop2(_key2) {
            ...
            579: (
              ...
              ((module2, __unused_webpack_exports, __webpack_require__2) => {
                ...
                var register = __name(function register2(cytoscape3) {
                  if (!cytoscape3) {
                    return;
                  }
...
//# sourceMappingURL=architectureDiagram-T4ORD67E-3PRO7GBC.js.map

...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/chunk-UAL2TQZE.mjs
...
async function erBox(parent, node) {
  ...
  shapeSvg.selectAll("g:not(:first-child)").each((_, i, nodes) => {
    const text2 = select_default2(nodes[i]);
...
async function addText2(parentGroup, node, yOffset, styles = []) {
  ...
  if (!useHtmlLabels) {
    if (styles.includes("font-weight: bolder")) {
      select_default2(text2).selectAll("tspan").attr("font-weight", "");
    }
...
//# sourceMappingURL=chunk-NXPHBAHD.js.map

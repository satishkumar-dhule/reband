...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/timeline-definition-EZH5CQRN.mjs
var parser = (function() {
...
function wrap(text, width) {
  text.each(function() {
    var text2 = select_default2(this), words = text2.text().split(/(\s+|<br>)/).reverse(), word, line = [], lineHeight = 1.1, y = text2.attr("y"), dy = parseFloat(text2.attr("dy")), tspan = text2.text(null).append("tspan").attr("x", 0).attr("y", y).attr("dy", dy + "em");
...
//# sourceMappingURL=timeline-definition-EZH5CQRN-3EGISX55.js.map

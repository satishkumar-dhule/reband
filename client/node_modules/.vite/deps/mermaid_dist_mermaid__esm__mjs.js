...
import {
  JSON_SCHEMA,
  load
} from "./chunk-FL6ERTJ7.js";
import {
  registerLayoutLoaders
} from "./chunk-IVYPZJ4J.js";
import "./chunk-M7M52XKK.js";
import "./chunk-JV3FHJTN.js";
import "./chunk-55P645IB.js";
import "./chunk-K2EBMJ3E.js";
import "./chunk-DDFQFRMX.js";
import "./chunk-DT74T5LA.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-NCLI6UF4.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/mermaid.esm.mjs
var id = "c4";
var detector = __name((txt) => {
  return /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(txt);
}, "detector");
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-DXJLMXH2-JCIIKT4X.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-DFBZ34RY-HVAH6S7H.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-GREGV3OQ-JIS3NTOV.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-HM4ZPWO2-TSJOKL6M.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-R4JZ7V63-CDCJUHRP.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-64PWAK7Z-D4SKIGMI.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-UGMOG4Z5-HA5D3JH2.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-VKKOZ4SM-ZZ6L3EUC.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-D2ZJGOGY-3N7OMFP6.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-6CIFHZUJ-DIIPLLRQ.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-KIA2NJ5P-TBJDSQR3.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-JHGXHCRH-4A5LKEAH.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-5BUKQR2M-Z4D6KUAQ.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-54RH4HMD-CMWQPFDT.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-2BQ6MTDL-QR37M4Y4.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-ZJUYVDM5-MTAHUIG2.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-EZH5CQRN-3EGISX55.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-EQ3ZS4SV-EVB32ALD.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-Q5TLOC5M-GO4ULSKQ.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-5FSKPGKG-4BP5ZT3G.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-DZK33KBB-SCZI27F3.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-SQQGPN5D-PEA3GRUN.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-NA4ZDWXF-H4CVAGXJ.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-T4ORD67E-LIUGOQN6.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-OBRH6LMB-2PXHLGTA.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-B44JW634-NVNOWEDM.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-KMU2TTTP-ENYSIZM5.js");
...
var render = __name(async function(id30, text, svgContainingElement) {
  ...
  if (svgContainingElement !== void 0) {
    ...
    if (isSandboxed) {
      ...
      root = select_default2(iframe.nodes()[0].contentDocument.body);
      root.node().style.margin = 0;
    } else {
      root = select_default2(svgContainingElement);
    }
...
var parse3 = __name(async (text, parseOptions) => {
...
//# sourceMappingURL=mermaid_dist_mermaid__esm__mjs.js.map

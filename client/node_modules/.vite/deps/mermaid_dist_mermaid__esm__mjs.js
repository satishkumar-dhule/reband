import {
  selectSvgElement
} from "./chunk-F2K4GJPF.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-DG64Z6DW.js";
import {
  registerLayoutLoaders
} from "./chunk-ZP4YL6V5.js";
import "./chunk-7OUFMHTS.js";
import "./chunk-R3PV5BRM.js";
import "./chunk-VTJQPB2R.js";
import "./chunk-IAPOZAAO.js";
import "./chunk-CZQYMXH7.js";
import "./chunk-2PMDHLIL.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-6CS6GAOH.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunk-KLC7AZM5.js";
import "./chunk-YEBXFNZJ.js";
import {
  UnknownDiagramError,
  addDirective,
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-P2I5NAKE.js";
import {
  log,
  select_default2,
  setLogLevel
} from "./chunk-WYIMLBM2.js";
import {
  isEmpty_default
} from "./chunk-XYVJIQID.js";
import "./chunk-ZRGWQ6SD.js";
import {
  __name
} from "./chunk-T3WI76UT.js";
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-DXJLMXH2-72HCCUX6.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-DFBZ34RY-LLKMURGA.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-GREGV3OQ-GAGQI37Q.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-HM4ZPWO2-BGP7XHPF.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-R4JZ7V63-CNOBNALX.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-64PWAK7Z-NOWDMGJF.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-UGMOG4Z5-SYORPUEF.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-VKKOZ4SM-6T2W7UFP.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-D2ZJGOGY-DRHF3NAO.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-6CIFHZUJ-ZGR6BCWT.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-KIA2NJ5P-R57T63OS.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-JHGXHCRH-XRKP6JOI.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-5BUKQR2M-7MFQ3EQ3.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-54RH4HMD-S7JY5E2R.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-2BQ6MTDL-QCC5ZH44.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-ZJUYVDM5-QMWD6CPB.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-EZH5CQRN-EUQLYDZZ.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-EQ3ZS4SV-COET7S2J.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-Q5TLOC5M-72VSPKER.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-5FSKPGKG-WZHRV25P.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-DZK33KBB-JTQULGYE.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-SQQGPN5D-DQYD2FPN.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-NA4ZDWXF-XFKM5NWB.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-T4ORD67E-WMENUB7C.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-OBRH6LMB-P32DB3OB.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-B44JW634-YOSCT5TJ.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-KMU2TTTP-PL2GMCV2.js");

import {
  getIconStyles
} from "./chunk-L5TLRK2N.js";
import {
  createTooltip
} from "./chunk-4Z2YNXEF.js";
import {
  getDiagramElement
} from "./chunk-Q3EQF7FG.js";
import {
  setupViewPortForSVG
...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/flowDiagram-DFBZ34RY.mjs
...
You have to call mermaid.initialize.`
  ...
  setupToolTips(element) {
    ...
    const svg = select_default2(element).select("svg");
    const nodes = svg.selectAll("g.node");
    nodes.on("mouseover", (e) => {
      const el = select_default2(e.currentTarget);
...
var draw = __name(async function(text, id, _version, diag) {
  ...
  for (const vertex of data4Layout.nodes) {
    const node = select_default2(`#${id} [id="${vertex.id}"]`);
    if (!node || !vertex.link) {
      continue;
    }
...
var fade = __name((color, opacity) => {
  const channel = channel_default2;
...
//# sourceMappingURL=flowDiagram-DFBZ34RY-ADJF3HEJ.js.map

import {
  __name
} from "./chunk-ZFLEOXIX.js";

// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/chunk-MDI5NGGP.mjs
...
var instanceStr = __name(function instanceStr2(obj) {
  return obj && obj.instanceString && fn$6(obj.instanceString) ? obj.instanceString() : null;
}, "instanceStr");
var string = __name(function string2(obj) {
  return obj != null && _typeof(obj) == typeofstr;
}, "string");
var fn$6 = __name(function fn(obj) {
  return obj != null && _typeof(obj) === typeoffn;
}, "fn");
var array = __name(function array2(obj) {
  return !elementOrCollection(obj) && (Array.isArray ? Array.isArray(obj) : obj != null && obj instanceof Array);
}, "array");
var plainObject = __name(function plainObject2(obj) {
  return obj != null && _typeof(obj) === typeofobj && !array(obj) && obj.constructor === Object;
}, "plainObject");
var object = __name(function object2(obj) {
  return obj != null && _typeof(obj) === typeofobj;
}, "object");
var number$1 = __name(function number(obj) {
  return obj != null && _typeof(obj) === _typeof(1) && !isNaN(obj);
}, "number");
var integer = __name(function integer2(obj) {
  return number$1(obj) && Math.floor(obj) === obj;
}, "integer");
var htmlElement = __name(function htmlElement2(obj) {
...
var elementOrCollection = __name(function elementOrCollection2(obj) {
  return element(obj) || collection(obj);
}, "elementOrCollection");
var element = __name(function element2(obj) {
  return instanceStr(obj) === "collection" && obj._private.single;
}, "element");
var collection = __name(function collection2(obj) {
  return instanceStr(obj) === "collection" && !obj._private.single;
}, "collection");
var core = __name(function core2(obj) {
  return instanceStr(obj) === "core";
}, "core");
var stylesheet = __name(function stylesheet2(obj) {
  return instanceStr(obj) === "stylesheet";
}, "stylesheet");
var event = __name(function event2(obj) {
  return instanceStr(obj) === "event";
}, "event");
var emptyString = __name(function emptyString2(obj) {
...
var domElement = __name(function domElement2(obj) {
...
var boundingBox = __name(function boundingBox2(obj) {
  return plainObject(obj) && number$1(obj.x1) && number$1(obj.x2) && number$1(obj.y1) && number$1(obj.y2);
}, "boundingBox");
var promise = __name(function promise2(obj) {
  return object(obj) && fn$6(obj.then);
}, "promise");
var ms = __name(function ms2() {
  return navigator && navigator.userAgent.match(/msie|trident|edge/i);
}, "ms");
var memoize = __name(function memoize2(fn3, keyFn) {
  if (!keyFn) {
    keyFn = __name(function keyFn2() {
  ...
  var _memoizedFn = __name(function memoizedFn() {
    var self2 = this;
    var args = arguments;
    var ret;
...
var capitalize = __name(function capitalize2(str) {
  if (emptyString(str)) {
    return str;
  }
  return str.charAt(0).toUpperCase() + str.substring(1);
}, "capitalize");
var endsWith = __name(function endsWith2(string3, suffix) {
...
var ascending = __name(function ascending2(a, b) {
  if (a < b) {
    return -1;
  } else if (a > b) {
    return 1;
...
var descending = __name(function descending2(a, b) {
...
var hex2tuple = __name(function hex2tuple2(hex) {
...
var hsl2tuple = __name(function hsl2tuple2(hsl) {
  var ret;
  var h, s, l, a, r, g, b;
...
var rgb2tuple = __name(function rgb2tuple2(rgb) {
  var ret;
...
var colorname2tuple = __name(function colorname2tuple2(color) {
  return colors[color.toLowerCase()];
}, "colorname2tuple");
var color2tuple = __name(function color2tuple2(color) {
...
var setMap = __name(function setMap2(options2) {
...
var getMap = __name(function getMap2(options2) {
  var obj = options2.map;
  var keys = options2.keys;
  var l = keys.length;
  for (var i2 = 0; i2 < l; i2++) {
...
var requestAnimationFrame = __name(function requestAnimationFrame2(fn3) {
  return raf(fn3);
...
var hashIterableInts = __name(function hashIterableInts2(iterator) {
...
var hashInt = __name(function hashInt2(num) {
  var seed = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : DEFAULT_HASH_SEED;
  return seed * K + num | 0;
}, "hashInt");
var hashIntAlt = __name(function hashIntAlt2(num) {
  var seed = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : DEFAULT_HASH_SEED_ALT;
  return (seed << 5) + seed + num | 0;
}, "hashIntAlt");
var combineHashes = __name(function combineHashes2(hash1, hash2) {
  return hash1 * 2097152 + hash2;
}, "combineHashes");
var combineHashesArray = __name(function combineHashesArray2(hashes) {
  return hashes[0] * 2097152 + hashes[1];
}, "combineHashesArray");
var hashArrays = __name(function hashArrays2(hashes1, hashes2) {
  return [hashInt(hashes1[0], hashes2[0]), hashIntAlt(hashes1[1], hashes2[1])];
}, "hashArrays");
var hashIntsArray = __name(function hashIntsArray2(ints, seed) {
  var entry = {
    value: 0,
    done: false
  };
...
var hashString = __name(function hashString2(str, seed) {
  var entry = {
    value: 0,
    done: false
  };
...
var hashStrings = __name(function hashStrings2() {
  return hashStringsArray(arguments);
}, "hashStrings");
var hashStringsArray = __name(function hashStringsArray2(strs) {
  var hash;
...
var movePointByBoxAspect = __name(function movePointByBoxAspect2(x2, y2, boxX, boxY, skewX, skewY) {
  return {
...
var trueify = __name(function trueify2() {
  return true;
}, "trueify");
var falsify = __name(function falsify2() {
  return false;
}, "falsify");
var zeroify = __name(function zeroify2() {
  return 0;
}, "zeroify");
var noop$1 = __name(function noop() {
}, "noop");
var error = __name(function error2(msg) {
  throw new Error(msg);
}, "error");
var warnings = __name(function warnings2(enabled) {
  if (enabled !== void 0) {
...
var warn = __name(function warn2(msg) {
  if (!warnings()) {
    return;
  }
  if (warnSupported) {
...
var clone = __name(function clone2(obj) {
  return extend({}, obj);
}, "clone");
var copy = __name(function copy2(obj) {
  if (obj == null) {
    return obj;
  }
  if (array(obj)) {
...
var copyArray = __name(function copyArray2(arr) {
  return arr.slice();
}, "copyArray");
var uuid = __name(function uuid2(a, b) {
  for (
    // loop :)
    b = a = "";
...
var staticEmptyObject = __name(function staticEmptyObject2() {
  return _staticEmptyObject;
}, "staticEmptyObject");
var defaults$g = __name(function defaults(_defaults) {
...
var removeFromArray = __name(function removeFromArray2(arr, ele, oneCopy) {
...
var clearArray = __name(function clearArray2(arr) {
  arr.splice(0, arr.length);
}, "clearArray");
var push = __name(function push2(arr, otherArr) {
  for (var i2 = 0; i2 < otherArr.length; i2++) {
    var el = otherArr[i2];
    arr.push(el);
  }
}, "push");
var getPrefixedProperty = __name(function getPrefixedProperty2(obj, propName, prefix) {
  if (prefix) {
    propName = prependCamel(prefix, propName);
  }
  return obj[propName];
}, "getPrefixedProperty");
var setPrefixedProperty = __name(function setPrefixedProperty2(obj, propName, prefix, value) {
  if (prefix) {
    propName = prependCamel(prefix, propName);
  }
  obj[propName] = value;
...
var ObjectMap = (function() {
  ...
  return _createClass(ObjectMap2, [{
    key: "set",
    value: __name(function set2(key, val) {
      this._obj[key] = val;
      return this;
    }, "set")
  }, {
    key: "delete",
    value: __name(function _delete(key) {
      this._obj[key] = void 0;
      return this;
    }, "_delete")
  }, {
    key: "clear",
    value: __name(function clear() {
      this._obj = {};
    }, "clear")
  }, {
    key: "has",
    value: __name(function has(key) {
      return this._obj[key] !== void 0;
    }, "has")
  }, {
    key: "get",
    value: __name(function get2(key) {
...
var ObjectSet = (function() {
  ...
  return _createClass(ObjectSet2, [{
    key: "instanceString",
    value: __name(function instanceString4() {
      return "set";
    }, "instanceString")
  }, {
    key: "add",
    value: __name(function add3(val) {
      var o = this._obj;
      if (o[val] !== 1) {
        o[val] = 1;
        this.size++;
    ...
    key: "delete",
    value: __name(function _delete(val) {
      var o = this._obj;
      if (o[val] === 1) {
        o[val] = 0;
        this.size--;
    ...
    key: "has",
    value: __name(function has(val) {
      return this._obj[val] === 1;
    }, "has")
  }, {
    key: "toArray",
    value: __name(function toArray2() {
      var _this = this;
    ...
    key: "forEach",
    value: __name(function forEach2(callback, thisArg) {
      return this.toArray().forEach(callback, thisArg);
    }, "forEach")
  }]);
})();
var Set$1 = (typeof Set === "undefined" ? "undefined" : _typeof(Set)) !== undef ? Set : ObjectSet;
var Element = __name(function Element2(cy, params) {
...
var defineSearch = __name(function defineSearch2(params) {
  params = {
    bfs: params.bfs || !params.dfs,
    dfs: params.dfs || !params.bfs
  };
  return __name(function searchFn(roots, fn3, directed) {
    var options2;
...
function requireHeap$1() {
  ...
  (function(module, exports) {
    (function() {
      ...
      defaultCmp = __name(function(x2, y2) {
        if (x2 < y2) {
          return -1;
        }
        if (x2 > y2) {
      ...
      insort = __name(function(a, x2, lo, hi, cmp) {
        var mid;
        if (lo == null) {
          lo = 0;
        }
      ...
      heappush = __name(function(array3, item, cmp) {
        if (cmp == null) {
          cmp = defaultCmp;
        }
        array3.push(item);
      ...
      heappop = __name(function(array3, cmp) {
      ...
      heapreplace = __name(function(array3, item, cmp) {
        var returnitem;
        if (cmp == null) {
          cmp = defaultCmp;
        }
      ...
      heappushpop = __name(function(array3, item, cmp) {
        var _ref;
        if (cmp == null) {
          cmp = defaultCmp;
        }
      ...
      heapify = __name(function(array3, cmp) {
      ...
      updateItem = __name(function(array3, item, cmp) {
        var pos;
        if (cmp == null) {
          cmp = defaultCmp;
        }
      ...
      nlargest = __name(function(array3, n, cmp) {
      ...
      nsmallest = __name(function(array3, n, cmp) {
      ...
      _siftdown = __name(function(array3, startpos, pos, cmp) {
      ...
      _siftup = __name(function(array3, pos, cmp) {
...
var dijkstraDefaults = defaults$g({
  root: null,
  weight: __name(function weight(edge) {
    return 1;
  }, "weight"),
  directed: false
});
var elesfn$u = {
  dijkstra: __name(function dijkstra(options2) {
    ...
    var getDist3 = __name(function getDist4(node2) {
      return dist3[node2.id()];
    }, "getDist");
    var setDist = __name(function setDist2(node2, d) {
      dist3[node2.id()] = d;
      Q.updateItem(node2);
    }, "setDist");
    ...
    var distBetween = __name(function distBetween2(u2, v3) {
    ...
    return {
      distanceTo: __name(function distanceTo(node2) {
        var target = string(node2) ? nodes3.filter(node2)[0] : node2[0];
        return knownDist[target.id()];
      }, "distanceTo"),
      pathTo: __name(function pathTo(node2) {
        var target = string(node2) ? nodes3.filter(node2)[0] : node2[0];
        var S = [];
        var u2 = target;
        var uid2 = u2.id();
...
var elesfn$t = {
  ...
  kruskal: __name(function kruskal(weightFn) {
    ...
    var A = nodes3;
    var findSetIndex = __name(function findSetIndex2(ele) {
      for (var i22 = 0; i22 < forest.length; i22++) {
        var eles = forest[i22];
        if (eles.has(ele)) {
          return i22;
        }
...
var aStarDefaults = defaults$g({
  root: null,
  goal: null,
  weight: __name(function weight2(edge) {
    return 1;
  }, "weight"),
  heuristic: __name(function heuristic(edge) {
    return 0;
  }, "heuristic"),
  directed: false
});
var elesfn$s = {
  // Implemented from pseudocode from wikipedia
  aStar: __name(function aStar(options2) {
    var cy = this.cy();
    ...
    var cameFrom = {};
    var cameFromEdge = {};
    var addToOpenSet = __name(function addToOpenSet2(ele, id2) {
      openSet.push(ele);
      openSetIds.add(id2);
    }, "addToOpenSet");
    var cMin, cMinId;
    var popFromOpenSet = __name(function popFromOpenSet2() {
      cMin = openSet.pop();
      cMinId = cMin.id();
      openSetIds["delete"](cMinId);
    }, "popFromOpenSet");
    var isInOpenSet = __name(function isInOpenSet2(id2) {
...
var floydWarshallDefaults = defaults$g({
  weight: __name(function weight3(edge) {
    return 1;
  }, "weight"),
  directed: false
});
var elesfn$r = {
  // Implemented from pseudocode from wikipedia
  floydWarshall: __name(function floydWarshall(options2) {
    var cy = this.cy();
    ...
    var N = nodes3.length;
    var Nsq = N * N;
    var indexOf = __name(function indexOf2(node) {
      return nodes3.indexOf(node);
    }, "indexOf");
    var atIndex = __name(function atIndex2(i22) {
      return nodes3[i22];
    }, "atIndex");
    ...
    var getArgEle = __name(function getArgEle2(ele) {
      return (string(ele) ? cy.filter(ele) : ele)[0];
    }, "getArgEle");
    var indexOfArgEle = __name(function indexOfArgEle2(ele) {
      return indexOf(getArgEle(ele));
    }, "indexOfArgEle");
    var res = {
      distance: __name(function distance(from, to) {
        var i22 = indexOfArgEle(from);
        var j2 = indexOfArgEle(to);
        return dist3[i22 * N + j2];
      }, "distance"),
      path: __name(function path(from, to) {
        var i22 = indexOfArgEle(from);
        var j2 = indexOfArgEle(to);
        var fromNode = atIndex(i22);
        if (i22 === j2) {
          return fromNode.collection();
        }
        if (next[i22 * N + j2] == null) {
        ...
        while (i22 !== j2) {
          prev = i22;
          i22 = next[i22 * N + j2];
          edge2 = edgeNext[prev * N + i22];
          path2.merge(edge2);
          path2.merge(atIndex(i22));
        }
        return path2;
      }, "path")
    };
...
var bellmanFordDefaults = defaults$g({
  weight: __name(function weight4(edge) {
    return 1;
  }, "weight"),
  directed: false,
  root: null
...
var elesfn$q = {
  // Implemented from pseudocode from wikipedia
  bellmanFord: __name(function bellmanFord(options2) {
    var _this = this;
    ...
    var getInfo3 = __name(function getInfo4(node2) {
    ...
    var getNodeFromTo = __name(function getNodeFromTo2(to) {
      return (string(to) ? cy.$(to) : to)[0];
    }, "getNodeFromTo");
    var distanceTo = __name(function distanceTo2(to) {
      return getInfo3(getNodeFromTo(to)).dist;
    }, "distanceTo");
    var pathTo = __name(function pathTo2(to) {
    ...
    var checkForEdgeReplacement = __name(function checkForEdgeReplacement2(node1, node2, edge2, info1, info2, weight9) {
...
var collapse = __name(function collapse2(edgeIndex, nodeMap, remainingEdges) {
...
var contractUntil = __name(function contractUntil2(metaNodeMap, remainingEdges, size3, sizeLimit) {
...
var elesfn$p = {
  ...
  kargerStein: __name(function kargerStein() {
    var _this = this;
    var _this$byGroup = this.byGroup(), nodes3 = _this$byGroup.nodes, edges3 = _this$byGroup.edges;
    ...
    var copyNodesMap = __name(function copyNodesMap2(from, to) {
    ...
    var constructComponent = __name(function constructComponent2(subset) {
...
var _Math$hypot;
var copyPosition = __name(function copyPosition2(p2) {
  return {
    x: p2.x,
    y: p2.y
  };
}, "copyPosition");
var modelToRenderedPosition$1 = __name(function modelToRenderedPosition(p2, zoom2, pan2) {
  return {
    x: p2.x * zoom2 + pan2.x,
    y: p2.y * zoom2 + pan2.y
  };
}, "modelToRenderedPosition");
var renderedToModelPosition = __name(function renderedToModelPosition2(p2, zoom2, pan2) {
  return {
    x: (p2.x - pan2.x) / zoom2,
    y: (p2.y - pan2.y) / zoom2
  };
}, "renderedToModelPosition");
var array2point = __name(function array2point2(arr) {
  return {
    x: arr[0],
    y: arr[1]
  };
}, "array2point");
var min = __name(function min2(arr) {
...
var max = __name(function max2(arr) {
  var begin = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
  var end = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : arr.length;
  var max5 = -Infinity;
  for (var i2 = begin; i2 < end; i2++) {
...
var mean = __name(function mean2(arr) {
  var begin = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
  var end = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : arr.length;
  var total = 0;
  var n = 0;
...
var median = __name(function median2(arr) {
  var begin = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
  var end = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : arr.length;
...
var deg2rad = __name(function deg2rad2(deg) {
  return Math.PI * deg / 180;
}, "deg2rad");
var getAngleFromDisp = __name(function getAngleFromDisp2(dispX, dispY) {
  return Math.atan2(dispY, dispX) - Math.PI / 2;
}, "getAngleFromDisp");
var log2 = Math.log2 || function(n) {
  return Math.log(n) / Math.log(2);
};
var signum = __name(function signum2(x2) {
  if (x2 > 0) {
    return 1;
  } else if (x2 < 0) {
    return -1;
...
var dist = __name(function dist2(p1, p2) {
  return Math.sqrt(sqdist(p1, p2));
}, "dist");
var sqdist = __name(function sqdist2(p1, p2) {
  var dx = p2.x - p1.x;
  var dy = p2.y - p1.y;
  return dx * dx + dy * dy;
}, "sqdist");
var inPlaceSumNormalize = __name(function inPlaceSumNormalize2(v) {
  var length = v.length;
  var total = 0;
...
var qbezierAt = __name(function qbezierAt2(p0, p1, p2, t) {
  return (1 - t) * (1 - t) * p0 + 2 * (1 - t) * t * p1 + t * t * p2;
}, "qbezierAt");
var qbezierPtAt = __name(function qbezierPtAt2(p0, p1, p2, t) {
  return {
    x: qbezierAt(p0.x, p1.x, p2.x, t),
    y: qbezierAt(p0.y, p1.y, p2.y, t)
  };
}, "qbezierPtAt");
var lineAt = __name(function lineAt2(p0, p1, t, d) {
  var vec = {
    x: p1.x - p0.x,
    y: p1.y - p0.y
  };
...
var bound = __name(function bound2(min4, val, max5) {
  return Math.max(min4, Math.min(max5, val));
}, "bound");
var makeBoundingBox = __name(function makeBoundingBox2(bb) {
  if (bb == null) {
    return {
      x1: Infinity,
      y1: Infinity,
...
var copyBoundingBox = __name(function copyBoundingBox2(bb) {
  return {
    x1: bb.x1,
    x2: bb.x2,
    w: bb.w,
...
var clearBoundingBox = __name(function clearBoundingBox2(bb) {
  bb.x1 = Infinity;
  bb.y1 = Infinity;
  bb.x2 = -Infinity;
  bb.y2 = -Infinity;
...
var updateBoundingBox = __name(function updateBoundingBox2(bb1, bb2) {
...
var expandBoundingBoxByPoint = __name(function expandBoundingBoxByPoint2(bb, x2, y2) {
...
var expandBoundingBox = __name(function expandBoundingBox2(bb) {
...
var expandBoundingBoxSides = __name(function expandBoundingBoxSides2(bb) {
  var padding = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [0];
...
var assignBoundingBox = __name(function assignBoundingBox2(bb1, bb2) {
  bb1.x1 = bb2.x1;
  bb1.y1 = bb2.y1;
  bb1.x2 = bb2.x2;
  bb1.y2 = bb2.y2;
...
var boundingBoxesIntersect = __name(function boundingBoxesIntersect2(bb1, bb2) {
  if (bb1.x1 > bb2.x2) {
    return false;
  }
  if (bb2.x1 > bb1.x2) {
...
var inBoundingBox = __name(function inBoundingBox2(bb, x2, y2) {
  return bb.x1 <= x2 && x2 <= bb.x2 && bb.y1 <= y2 && y2 <= bb.y2;
}, "inBoundingBox");
var pointInBoundingBox = __name(function pointInBoundingBox2(bb, pt) {
  return inBoundingBox(bb, pt.x, pt.y);
}, "pointInBoundingBox");
var boundingBoxInBoundingBox = __name(function boundingBoxInBoundingBox2(bb1, bb2) {
...
function inflatePolygon(polygon2, d) {
  ...
  var add3 = __name(function add4(a, b) {
    return {
      x: a.x + b.x,
      y: a.y + b.y
    };
  }, "add");
  var sub = __name(function sub2(a, b) {
    return {
      x: a.x - b.x,
      y: a.y - b.y
    };
  }, "sub");
  var scale2 = __name(function scale3(v, s) {
    return {
      x: v.x * s,
      y: v.y * s
    };
  }, "scale");
  var cross = __name(function cross2(u, v) {
    return u.x * v.y - u.y * v.x;
  }, "cross");
  var normalize3 = __name(function normalize4(v) {
  ...
  var signedArea = __name(function signedArea2(pts3) {
    var A = 0;
    for (var i22 = 0; i22 < pts3.length; i22++) {
      var p3 = pts3[i22], q2 = pts3[(i22 + 1) % pts3.length];
      A += p3.x * q2.y - q2.x * p3.y;
    }
    return A / 2;
  }, "signedArea");
  var intersectLines = __name(function intersectLines2(p1, p22, p3, p4) {
    var r = sub(p22, p1);
    var s = sub(p4, p3);
    var denom = cross(r, s);
  ...
  var offsetEdges = normals.map(function(nrm, i22) {
    var p1 = add3(pts2[i22], scale2(nrm, d));
    var p22 = add3(pts2[(i22 + 1) % n], scale2(nrm, d));
    return {
      p1,
      p2: p22
    };
...
var roundRectangleIntersectLine = __name(function roundRectangleIntersectLine2(x2, y2, nodeX, nodeY, width2, height2, padding) {
...
var inLineVicinity = __name(function inLineVicinity2(x2, y2, lx1, ly1, lx2, ly2, tolerance) {
  var t = tolerance;
...
var inBezierVicinity = __name(function inBezierVicinity2(x2, y2, x1, y1, x22, y22, x3, y3, tolerance) {
  var bb = {
...
var solveQuadratic = __name(function solveQuadratic2(a, b, c, val) {
  c -= val;
  var r = b * b - 4 * a * c;
  if (r < 0) {
    return [];
...
var solveCubic = __name(function solveCubic2(a, b, c, d, result) {
  var epsilon = 1e-5;
  if (a === 0) {
    a = epsilon;
  }
...
var sqdistToQuadraticBezier = __name(function sqdistToQuadraticBezier2(x2, y2, x1, y1, x22, y22, x3, y3) {
...
var sqdistToFiniteLine = __name(function sqdistToFiniteLine2(x2, y2, x1, y1, x22, y22) {
...
var pointInsidePolygonPoints = __name(function pointInsidePolygonPoints2(x2, y2, points) {
  var x1, y1, x22, y22;
  var y3;
  var up = 0;
...
var pointInsidePolygon = __name(function pointInsidePolygon2(x2, y2, basePoints, centerX, centerY, width2, height2, direction, padding) {
...
var pointInsideRoundPolygon = __name(function pointInsideRoundPolygon2(x2, y2, basePoints, centerX, centerY, width2, height2, corners) {
...
var joinLines = __name(function joinLines2(lineSet) {
...
var expandPolygon = __name(function expandPolygon2(points, pad) {
...
var intersectLineEllipse = __name(function intersectLineEllipse2(x2, y2, centerX, centerY, ellipseWradius, ellipseHradius) {
...
var checkInEllipse = __name(function checkInEllipse2(x2, y2, width2, height2, centerX, centerY, padding) {
  x2 -= centerX;
  y2 -= centerY;
  x2 /= width2 / 2 + padding;
...
var intersectLineCircle = __name(function intersectLineCircle2(x1, y1, x2, y2, centerX, centerY, radius2) {
  var d = [x2 - x1, y2 - y1];
...
var midOfThree = __name(function midOfThree2(a, b, c) {
  if (b <= a && a <= c || c <= a && a <= b) {
    return a;
...
var finiteLinesIntersect = __name(function finiteLinesIntersect2(x1, y1, x2, y2, x3, y3, x4, y4, infiniteLines) {
  var dx13 = x1 - x3;
  var dx21 = x2 - x1;
  var dx43 = x4 - x3;
  var dy13 = y1 - y3;
...
var transformPoints = __name(function transformPoints2(points, centerX, centerY, width2, height2) {
  var ret = [];
  var halfW = width2 / 2;
  var halfH = height2 / 2;
  var x2 = centerX;
...
var polygonIntersectLine = __name(function polygonIntersectLine2(x2, y2, basePoints, centerX, centerY, width2, height2, padding) {
  var intersections = [];
  var intersection2;
  var transformedPoints = new Array(basePoints.length);
...
var roundPolygonIntersectLine = __name(function roundPolygonIntersectLine2(x2, y2, basePoints, centerX, centerY, width2, height2, padding, corners) {
  var intersections = [];
  var intersection2;
  var lines = new Array(basePoints.length * 2);
  corners.forEach(function(corner, i22) {
    if (i22 === 0) {
      lines[lines.length - 2] = corner.startX;
      lines[lines.length - 1] = corner.startY;
    } else {
      lines[i22 * 4 - 2] = corner.startX;
      lines[i22 * 4 - 1] = corner.startY;
    }
    lines[i22 * 4] = corner.stopX;
    lines[i22 * 4 + 1] = corner.stopY;
...
var shortenIntersection = __name(function shortenIntersection2(intersection2, offset, amount) {
...
var generateUnitNgonPointsFitToSquare = __name(function generateUnitNgonPointsFitToSquare2(sides, rotationRadians) {
  var points = generateUnitNgonPoints(sides, rotationRadians);
  points = fitPolygonToSquare(points);
  return points;
}, "generateUnitNgonPointsFitToSquare");
var fitPolygonToSquare = __name(function fitPolygonToSquare2(points) {
  var x2, y2;
...
var generateUnitNgonPoints = __name(function generateUnitNgonPoints2(sides, rotationRadians) {
...
var getRoundRectangleRadius = __name(function getRoundRectangleRadius2(width2, height2) {
  return Math.min(width2 / 4, height2 / 4, 8);
}, "getRoundRectangleRadius");
var getRoundPolygonRadius = __name(function getRoundPolygonRadius2(width2, height2) {
  return Math.min(width2 / 10, height2 / 10, 8);
}, "getRoundPolygonRadius");
var getCutRectangleCornerLength = __name(function getCutRectangleCornerLength2() {
  return 8;
}, "getCutRectangleCornerLength");
var bezierPtsToQuadCoeff = __name(function bezierPtsToQuadCoeff2(p0, p1, p2) {
  return [p0 - 2 * p1 + p2, 2 * (p1 - p0), p0];
}, "bezierPtsToQuadCoeff");
var getBarrelCurveConstants = __name(function getBarrelCurveConstants2(width2, height2) {
  return {
...
var pageRankDefaults = defaults$g({
  ...
  precision: 1e-6,
  iterations: 200,
  weight: __name(function weight5(edge) {
    return 1;
  }, "weight")
});
var elesfn$o = {
  pageRank: __name(function pageRank(options2) {
    ...
    var res = {
      rank: __name(function rank(node) {
...
var defaults$f = defaults$g({
  root: null,
  weight: __name(function weight6(edge) {
    return 1;
  }, "weight"),
  directed: false,
  alpha: 0
...
var elesfn$n = {
  degreeCentralityNormalized: __name(function degreeCentralityNormalized(options2) {
    ...
    if (!options2.directed) {
      ...
      return {
        degree: __name(function degree(node2) {
          if (maxDegree === 0) {
            return 0;
          }
          if (string(node2)) {
      ...
      return {
        indegree: __name(function indegree(node2) {
          if (maxIndegree == 0) {
            return 0;
          }
          if (string(node2)) {
        ...
        outdegree: __name(function outdegree(node2) {
          if (maxOutdegree === 0) {
            return 0;
          }
          if (string(node2)) {
  ...
  degreeCentrality: __name(function degreeCentrality(options2) {
    options2 = defaults$f(options2);
    var cy = this.cy();
...
var defaults$e = defaults$g({
  harmonic: true,
  weight: __name(function weight7() {
    return 1;
  }, "weight"),
  directed: false,
  root: null
...
var elesfn$m = {
  closenessCentralityNormalized: __name(function closenessCentralityNormalized(options2) {
    ...
    return {
      closeness: __name(function closeness(node) {
        if (maxCloseness == 0) {
          return 0;
        }
        if (string(node)) {
  ...
  // Implemented from pseudocode from wikipedia
  closenessCentrality: __name(function closenessCentrality(options2) {
...
var elesfn$l = {
  ...
  betweennessCentrality: __name(function betweennessCentrality(options2) {
    ...
    var max5 = 0;
    var C = {
      set: __name(function set2(key, val) {
        _C[key] = val;
        if (val > max5) {
          max5 = val;
        }
      }, "set"),
      get: __name(function get2(key) {
        return _C[key];
      }, "get")
    };
    for (var i2 = 0; i2 < V.length; i2++) {
    ...
    var ret = {
      betweenness: __name(function betweenness(node) {
        var id2 = cy.collection(node).id();
        return C.get(id2);
      }, "betweenness"),
      betweennessNormalized: __name(function betweennessNormalized(node) {
        if (max5 == 0) {
          return 0;
        }
        var id2 = cy.collection(node).id();
...
var setOptions$3 = __name(function setOptions(options2) {
  return defaults$c(options2);
}, "setOptions");
var getSimilarity$1 = __name(function getSimilarity(edge, attributes) {
  var total = 0;
...
var addLoops = __name(function addLoops2(M, n, val) {
  for (var i2 = 0; i2 < n; i2++) {
    M[i2 * n + i2] = val;
  }
}, "addLoops");
var normalize = __name(function normalize2(M, n) {
  var sum;
...
var mmult = __name(function mmult2(A, B, n) {
  var C = new Array(n * n);
  for (var i2 = 0; i2 < n; i2++) {
    for (var j = 0; j < n; j++) {
      C[i2 * n + j] = 0;
...
var expand = __name(function expand2(M, n, expandFactor) {
  var _M = M.slice(0);
...
var inflate = __name(function inflate2(M, n, inflateFactor) {
...
var hasConverged = __name(function hasConverged2(M, _M, n2, roundFactor) {
...
var assign$2 = __name(function assign(M, n, nodes3, cy) {
  var clusters = [];
  for (var i2 = 0; i2 < n; i2++) {
    var cluster = [];
    for (var j = 0; j < n; j++) {
...
var isDuplicate = __name(function isDuplicate2(c1, c2) {
...
var removeDuplicates = __name(function removeDuplicates2(clusters) {
...
var markovClustering = __name(function markovClustering2(options2) {
  var nodes3 = this.nodes();
...
var identity$1 = __name(function identity(x2) {
  return x2;
}, "identity");
var absDiff = __name(function absDiff2(p2, q) {
  return Math.abs(q - p2);
}, "absDiff");
var addAbsDiff = __name(function addAbsDiff2(total, p2, q) {
  return total + absDiff(p2, q);
}, "addAbsDiff");
var addSquaredDiff = __name(function addSquaredDiff2(total, p2, q) {
  return total + Math.pow(q - p2, 2);
}, "addSquaredDiff");
var sqrt = __name(function sqrt3(x2) {
  return Math.sqrt(x2);
}, "sqrt");
var maxAbsDiff = __name(function maxAbsDiff2(currentMax, p2, q) {
  return Math.max(currentMax, absDiff(p2, q));
}, "maxAbsDiff");
var getDistance = __name(function getDistance2(length, getP, getQ, init, visit) {
...
var distances = {
  euclidean: __name(function euclidean(length, getP, getQ) {
    if (length >= 2) {
  ...
  squaredEuclidean: __name(function squaredEuclidean(length, getP, getQ) {
    return getDistance(length, getP, getQ, 0, addSquaredDiff);
  }, "squaredEuclidean"),
  manhattan: __name(function manhattan(length, getP, getQ) {
    return getDistance(length, getP, getQ, 0, addAbsDiff);
  }, "manhattan"),
  max: __name(function max3(length, getP, getQ) {
...
var setOptions$2 = __name(function setOptions2(options2) {
  return defaults$b(options2);
}, "setOptions");
var getDist = __name(function getDist2(type, node, centroid, attributes, mode) {
  ...
  var getQ = __name(function getQ2(i2) {
...
var randomCentroids = __name(function randomCentroids2(nodes3, k, attributes) {
...
var classify = __name(function classify2(node, centroids, distance, attributes, type) {
  var min4 = Infinity;
  var index = 0;
...
var buildCluster = __name(function buildCluster2(centroid, nodes3, assignment) {
  var cluster = [];
  var node = null;
...
var haveValuesConverged = __name(function haveValuesConverged2(v12, v22, sensitivityThreshold) {
  return Math.abs(v22 - v12) <= sensitivityThreshold;
}, "haveValuesConverged");
var haveMatricesConverged = __name(function haveMatricesConverged2(v12, v22, sensitivityThreshold) {
...
var seenBefore = __name(function seenBefore2(node, medoids, n) {
  for (var i2 = 0; i2 < n; i2++) {
    if (node === medoids[i2]) return true;
  }
  return false;
}, "seenBefore");
var randomMedoids = __name(function randomMedoids2(nodes3, k) {
...
var findCost = __name(function findCost2(potentialNewMedoid, cluster, attributes) {
  var cost = 0;
...
var kMeans = __name(function kMeans2(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  var node = null;
...
var kMedoids = __name(function kMedoids2(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  var node = null;
  var opts = setOptions$2(options2);
...
var updateCentroids = __name(function updateCentroids2(centroids, nodes3, U, weight8, opts) {
...
var updateMembership = __name(function updateMembership2(U, _U, centroids, nodes3, opts) {
...
var assign$1 = __name(function assign2(nodes3, U, opts, cy) {
  var clusters = new Array(opts.k);
...
var fuzzyCMeans = __name(function fuzzyCMeans2(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  var opts = setOptions$2(options2);
  var clusters;
...
var setOptions$1 = __name(function setOptions3(options2) {
...
var mergeClosest = __name(function mergeClosest2(clusters, index, dists, mins, opts) {
  var minKey = 0;
  var min4 = Infinity;
  var dist3;
  var attrs = opts.attributes;
  var getDist3 = __name(function getDist4(n1, n2) {
    return clusteringDistance(opts.distance, attrs.length, function(i22) {
      return attrs[i22](n1);
    }, function(i22) {
      return attrs[i22](n2);
    }, n1, n2);
...
var _getAllChildren = __name(function getAllChildren(root, arr, cy) {
  if (!root) return;
  if (root.value) {
    arr.push(root.value);
  } else {
...
var _buildDendrogram = __name(function buildDendrogram(root, cy) {
  if (!root) return "";
...
var _buildClustersFromTree = __name(function buildClustersFromTree(root, k, cy) {
  if (!root) return [];
...
var hierarchicalClustering = __name(function hierarchicalClustering2(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
  ...
  if (opts.mode === "dendrogram") {
    ...
    clusters.forEach(function(cluster2, i22) {
      cluster2.key = cluster2.index = null;
      retClusters[i22] = cy.collection(cluster2.value);
    });
  }
  return retClusters;
...
var setOptions4 = __name(function setOptions5(options2) {
...
var getSimilarity2 = __name(function getSimilarity3(type, n1, n2, attributes) {
  var attr = __name(function attr2(n, i2) {
...
var getPreference = __name(function getPreference2(S, preference) {
  var p2 = null;
...
var findExemplars = __name(function findExemplars2(n, R, A) {
  var indices = [];
  for (var i2 = 0; i2 < n; i2++) {
...
var assignClusters = __name(function assignClusters2(n, S, exemplars) {
  var clusters = [];
  for (var i2 = 0; i2 < n; i2++) {
    var index = -1;
    var max5 = -Infinity;
...
var assign3 = __name(function assign4(n, S, exemplars) {
...
var affinityPropagation = __name(function affinityPropagation2(options2) {
  var cy = this.cy();
  var nodes3 = this.nodes();
...
var elesfn$k = {
  hierholzer: __name(function hierholzer(options2) {
    if (!plainObject(options2)) {
      var args = arguments;
      options2 = {
        root: args[0],
    ...
    var walk = __name(function walk2(v) {
      var currentNode = v;
      var subtour2 = [v];
...
var hopcroftTarjanBiconnected = __name(function hopcroftTarjanBiconnected2() {
  var eles = this;
  var nodes3 = {};
  var id2 = 0;
  var edgeCount = 0;
  ...
  var stack = [];
  var visitedEdges = {};
  var buildComponent = __name(function buildComponent2(x2, y2) {
  ...
  var _biconnectedSearch = __name(function biconnectedSearch(root, currentNode, parent4) {
...
var tarjanStronglyConnected = __name(function tarjanStronglyConnected2() {
  var eles = this;
  var nodes3 = {};
  var index = 0;
  var components2 = [];
  ...
  var _stronglyConnectedSearch = __name(function stronglyConnectedSearch(sourceNodeId) {
...
var _api = __name(function api(executor) {
...
_api.prototype = {
  ...
  fulfill: __name(function fulfill(value) {
    return deliver(this, STATE_FULFILLED, "fulfillValue", value);
  }, "fulfill"),
  reject: __name(function reject(value) {
    return deliver(this, STATE_REJECTED, "rejectReason", value);
  }, "reject"),
  /*  "The then Method" [Promises/A+ 1.1, 1.2, 2.2]  */
  then: __name(function then(onFulfilled, onRejected) {
    var curr = this;
    var next = new _api();
...
var deliver = __name(function deliver2(curr, state, name, value) {
...
var execute = __name(function execute2(curr) {
...
var execute_handlers = __name(function execute_handlers2(curr, name, value) {
  if (curr[name].length === 0) return;
  var handlers = curr[name];
  curr[name] = [];
  var func = __name(function func2() {
...
var resolver = __name(function resolver2(cb, next, method) {
...
var _resolve = __name(function resolve(promise4, x2) {
...
_api.all = function(ps) {
  return new _api(function(resolveAll, rejectAll) {
    ...
    var doneCount = 0;
    var fulfill2 = __name(function fulfill3(i22, val) {
      vals[i22] = val;
      doneCount++;
...
var Animation = __name(function Animation2(target, opts, opts2) {
...
extend(anifn, {
  instanceString: __name(function instanceString() {
    return "animation";
  }, "instanceString"),
  hook: __name(function hook() {
    var _p = this._private;
    if (!_p.hooked) {
      var q;
  ...
  playing: __name(function playing() {
    return this._private.playing;
  }, "playing"),
  apply: __name(function apply() {
    var _p = this._private;
    _p.applying = true;
    _p.started = false;
    _p.stopped = false;
  ...
  applying: __name(function applying() {
    return this._private.applying;
  }, "applying"),
  pause: __name(function pause() {
    var _p = this._private;
    _p.playing = false;
    _p.started = false;
    return this;
  }, "pause"),
  stop: __name(function stop() {
    var _p = this._private;
    _p.playing = false;
    _p.started = false;
    _p.stopped = true;
  ...
  rewind: __name(function rewind() {
    return this.progress(0);
  }, "rewind"),
  fastforward: __name(function fastforward() {
    return this.progress(1);
  }, "fastforward"),
  time: __name(function time(t) {
    var _p = this._private;
    if (t === void 0) {
  ...
  progress: __name(function progress(p2) {
    var _p = this._private;
  ...
  completed: __name(function completed() {
  ...
  reverse: __name(function reverse() {
    ...
    _p.started = false;
    var swap = __name(function swap2(a, b) {
      var _pa = _p[a];
      if (_pa == null) {
        return;
      }
  ...
  promise: __name(function promise3(type) {
    var _p = this._private;
    var arr;
    switch (type) {
      case "frame":
...
var define$3 = {
  animated: __name(function animated() {
    return __name(function animatedImpl() {
      var self2 = this;
  ...
  // animated
  clearQueue: __name(function clearQueue() {
    return __name(function clearQueueImpl() {
      var self2 = this;
      var selfIsArrayLike = self2.length !== void 0;
      var all = selfIsArrayLike ? self2 : [self2];
      var cy = this._private.cy || this;
  ...
  // clearQueue
  delay: __name(function delay() {
    return __name(function delayImpl(time2, complete) {
      var cy = this._private.cy || this;
      if (!cy.styleEnabled()) {
        return this;
      }
  ...
  // delay
  delayAnimation: __name(function delayAnimation() {
    return __name(function delayAnimationImpl(time2, complete) {
      var cy = this._private.cy || this;
      if (!cy.styleEnabled()) {
        return this;
      }
  ...
  // delay
  animation: __name(function animation() {
    return __name(function animationImpl(properties, params) {
      var self2 = this;
      var selfIsArrayLike = self2.length !== void 0;
      var all = selfIsArrayLike ? self2 : [self2];
      var cy = this._private.cy || this;
  ...
  // animate
  animate: __name(function animate() {
    return __name(function animateImpl(properties, params) {
      var self2 = this;
      var selfIsArrayLike = self2.length !== void 0;
      var all = selfIsArrayLike ? self2 : [self2];
      var cy = this._private.cy || this;
  ...
  // animate
  stop: __name(function stop2() {
    return __name(function stopImpl(clearQueue2, jumpToEnd) {
      var self2 = this;
      var selfIsArrayLike = self2.length !== void 0;
      var all = selfIsArrayLike ? self2 : [self2];
      var cy = this._private.cy || this;
...
var define$2 = {
  // access data field
  data: __name(function data(params) {
    var defaults3 = {
      field: "data",
      bindingEvent: "data",
      allowBinding: false,
      ...
      updateStyle: false,
      beforeGet: __name(function beforeGet2(self2) {
      }, "beforeGet"),
      beforeSet: __name(function beforeSet3(self2, obj) {
      }, "beforeSet"),
      onSet: __name(function onSet3(self2) {
      }, "onSet"),
      canSet: __name(function canSet2(self2) {
        return true;
      }, "canSet")
    };
    params = extend({}, defaults3, params);
    return __name(function dataImpl(name, value) {
      var p2 = params;
      var self2 = this;
      var selfIsArrayLike = self2.length !== void 0;
      var all = selfIsArrayLike ? self2 : [self2];
  ...
  // data
  // remove data field
  removeData: __name(function removeData(params) {
    var defaults3 = {
      field: "data",
      event: "data",
      triggerFnName: "trigger",
    ...
    params = extend({}, defaults3, params);
    return __name(function removeDataImpl(names) {
      var p2 = params;
      var self2 = this;
      var selfIsArrayLike = self2.length !== void 0;
      var all = selfIsArrayLike ? self2 : [self2];
...
var define$1 = {
  eventAliasesOn: __name(function eventAliasesOn(proto) {
    var p2 = proto;
    ...
    p2.pon = p2.promiseOn = function(events, selector) {
      ...
      return new Promise$1(function(resolve2, reject2) {
        var callback = __name(function callback2(e) {
...
var elesfn$h = {
  classes: __name(function classes(_classes) {
    var self2 = this;
    if (_classes === void 0) {
      var ret = [];
  ...
  addClass: __name(function addClass(classes2) {
    return this.toggleClass(classes2, true);
  }, "addClass"),
  hasClass: __name(function hasClass(className) {
    var ele = this[0];
    return ele != null && ele._private.classes.has(className);
  }, "hasClass"),
  toggleClass: __name(function toggleClass(classes2, toggle) {
    if (!array(classes2)) {
  ...
  removeClass: __name(function removeClass(classes2) {
    return this.toggleClass(classes2, false);
  }, "removeClass"),
  flashClass: __name(function flashClass(classes2, duration) {
    var self2 = this;
    if (duration == null) {
      duration = 250;
    } else if (duration === 0) {
...
var newQuery = __name(function newQuery2() {
  return {
    checks: []
  };
}, "newQuery");
...
var stateSelectors = [{
  selector: ":selected",
  matches: __name(function matches(ele) {
    return ele.selected();
  }, "matches")
}, {
  selector: ":unselected",
  matches: __name(function matches2(ele) {
    return !ele.selected();
  }, "matches")
}, {
  selector: ":selectable",
  matches: __name(function matches3(ele) {
    return ele.selectable();
  }, "matches")
}, {
  selector: ":unselectable",
  matches: __name(function matches4(ele) {
    return !ele.selectable();
  }, "matches")
}, {
  selector: ":locked",
  matches: __name(function matches5(ele) {
    return ele.locked();
  }, "matches")
}, {
  selector: ":unlocked",
  matches: __name(function matches6(ele) {
    return !ele.locked();
  }, "matches")
}, {
  selector: ":visible",
  matches: __name(function matches7(ele) {
    return ele.visible();
  }, "matches")
}, {
  selector: ":hidden",
  matches: __name(function matches8(ele) {
    return !ele.visible();
  }, "matches")
}, {
  selector: ":transparent",
  matches: __name(function matches9(ele) {
    return ele.transparent();
  }, "matches")
}, {
  selector: ":grabbed",
  matches: __name(function matches10(ele) {
    return ele.grabbed();
  }, "matches")
}, {
  selector: ":free",
  matches: __name(function matches11(ele) {
    return !ele.grabbed();
  }, "matches")
}, {
  selector: ":removed",
  matches: __name(function matches12(ele) {
    return ele.removed();
  }, "matches")
}, {
  selector: ":inside",
  matches: __name(function matches13(ele) {
    return !ele.removed();
  }, "matches")
}, {
  selector: ":grabbable",
  matches: __name(function matches14(ele) {
    return ele.grabbable();
  }, "matches")
}, {
  selector: ":ungrabbable",
  matches: __name(function matches15(ele) {
    return !ele.grabbable();
  }, "matches")
}, {
  selector: ":animated",
  matches: __name(function matches16(ele) {
    return ele.animated();
  }, "matches")
}, {
  selector: ":unanimated",
  matches: __name(function matches17(ele) {
    return !ele.animated();
  }, "matches")
}, {
  selector: ":parent",
  matches: __name(function matches18(ele) {
    return ele.isParent();
  }, "matches")
}, {
  selector: ":childless",
  matches: __name(function matches19(ele) {
    return ele.isChildless();
  }, "matches")
}, {
  selector: ":child",
  matches: __name(function matches20(ele) {
    return ele.isChild();
  }, "matches")
}, {
  selector: ":orphan",
  matches: __name(function matches21(ele) {
    return ele.isOrphan();
  }, "matches")
}, {
  selector: ":nonorphan",
  matches: __name(function matches22(ele) {
    return ele.isChild();
  }, "matches")
}, {
  selector: ":compound",
  matches: __name(function matches23(ele) {
    if (ele.isNode()) {
      return ele.isParent();
    } else {
  ...
  selector: ":loop",
  matches: __name(function matches24(ele) {
    return ele.isLoop();
  }, "matches")
}, {
  selector: ":simple",
  matches: __name(function matches25(ele) {
    return ele.isSimple();
  }, "matches")
}, {
  selector: ":active",
  matches: __name(function matches26(ele) {
    return ele.active();
  }, "matches")
}, {
  selector: ":inactive",
  matches: __name(function matches27(ele) {
    return !ele.active();
  }, "matches")
}, {
  selector: ":backgrounding",
  matches: __name(function matches28(ele) {
    return ele.backgrounding();
  }, "matches")
}, {
  selector: ":nonbackgrounding",
  matches: __name(function matches29(ele) {
    return !ele.backgrounding();
  }, "matches")
}].sort(function(a, b) {
...
var stateSelectorMatches = __name(function stateSelectorMatches2(sel, ele) {
  return lookup[sel](ele);
}, "stateSelectorMatches");
var stateSelectorRegex = "(" + stateSelectors.map(function(s) {
  return s.selector;
}).join("|") + ")";
var cleanMetaChars = __name(function cleanMetaChars2(str) {
  return str.replace(new RegExp("\\\\(" + tokens.metaChar + ")", "g"), function(match2, $1) {
    return $1;
  });
}, "cleanMetaChars");
var replaceLastQuery = __name(function replaceLastQuery2(selector, examiningQuery, replacementQuery) {
...
var exprs = [{
  ...
  query: true,
  regex: "(" + tokens.group + ")",
  populate: __name(function populate(selector, query, _ref) {
  ...
  populate: __name(function populate2(selector, query, _ref3) {
  ...
  query: true,
  regex: "\\#(" + tokens.id + ")",
  populate: __name(function populate3(selector, query, _ref5) {
  ...
  populate: __name(function populate4(selector, query, _ref7) {
  ...
  populate: __name(function populate5(selector, query, _ref9) {
  ...
  populate: __name(function populate6(selector, query, _ref11) {
  ...
  populate: __name(function populate7(selector, query, _ref13) {
  ...
  populate: __name(function populate8(selector, query, _ref15) {
  ...
  populate: __name(function populate9(selector, query) {
  ...
  populate: __name(function populate10(selector, query) {
  ...
  populate: __name(function populate11(selector, query) {
    if (selector.currentSubject == null) {
      var edgeQuery = newQuery();
      var source = query;
      var target = newQuery();
  ...
  separator: true,
  regex: tokens.child,
  populate: __name(function populate12(selector, query) {
    if (selector.currentSubject == null) {
  ...
  populate: __name(function populate13(selector, query) {
    if (selector.currentSubject == null) {
  ...
  populate: __name(function populate14(selector, query) {
...
var consumeExpr = __name(function consumeExpr2(remaining) {
  var expr;
  var match2;
  var name;
...
var consumeWhitespace = __name(function consumeWhitespace2(remaining) {
...
var parse = __name(function parse2(selector) {
  var self2 = this;
...
var toString = __name(function toString2() {
  if (this.toStringCache != null) {
    return this.toStringCache;
  }
  var clean = __name(function clean2(obj) {
    if (obj == null) {
      return "";
    } else {
      return obj;
  ...
  var cleanVal = __name(function cleanVal2(val) {
    if (string(val)) {
      return '"' + val + '"';
    } else {
      return clean(val);
  ...
  var space = __name(function space2(val) {
    return " " + val + " ";
  }, "space");
  var checkToString = __name(function checkToString2(check, subject) {
  ...
  var queryToString = __name(function queryToString2(query2, subject) {
    return query2.checks.reduce(function(str2, chk, i22) {
      return str2 + (subject === query2 && i22 === 0 ? "$" : "") + checkToString(chk, subject);
    }, "");
  }, "queryToString");
  var str = "";
...
var valCmp = __name(function valCmp2(fieldVal, operator, value) {
  var matches33;
...
var boolCmp = __name(function boolCmp2(fieldVal, operator) {
  switch (operator) {
    case "?":
...
var existCmp = __name(function existCmp2(fieldVal) {
  return fieldVal !== void 0;
}, "existCmp");
var data$1 = __name(function data2(ele, field) {
  return ele.data(field);
}, "data");
var meta = __name(function meta2(ele, field) {
  return ele[field]();
}, "meta");
var match = [];
var matches$1 = __name(function matches30(query, ele) {
...
var filter = __name(function filter2(collection4) {
  var self2 = this;
  ...
  var selectorFunction = __name(function selectorFunction2(element3) {
    for (var j = 0; j < self2.length; j++) {
      var query = self2[j];
  ...
  if (self2.text() == null) {
    selectorFunction = __name(function selectorFunction2() {
      return true;
    }, "selectorFunction");
  }
  return collection4.filter(selectorFunction);
}, "filter");
var matches31 = __name(function matches32(ele) {
  var self2 = this;
  for (var j = 0; j < self2.length; j++) {
    var query = self2[j];
...
var Selector = __name(function Selector2(selector) {
...
var elesfn$g = {
  allAre: __name(function allAre(selector) {
    var selObj = new Selector(selector);
    return this.every(function(ele) {
      return selObj.matches(ele);
    });
  }, "allAre"),
  is: __name(function is(selector) {
    var selObj = new Selector(selector);
    return this.some(function(ele) {
      return selObj.matches(ele);
    });
  }, "is"),
  some: __name(function some(fn3, thisArg) {
    for (var i2 = 0; i2 < this.length; i2++) {
  ...
  every: __name(function every(fn3, thisArg) {
    for (var i2 = 0; i2 < this.length; i2++) {
      var ret = !thisArg ? fn3(this[i2], i2, this) : fn3.apply(thisArg, [this[i2], i2, this]);
      if (!ret) {
        return false;
  ...
  same: __name(function same(collection4) {
    if (this === collection4) {
      return true;
    }
  ...
  anySame: __name(function anySame(collection4) {
    collection4 = this.cy().collection(collection4);
    return this.some(function(ele) {
      return collection4.hasElementWithId(ele.id());
    });
  }, "anySame"),
  allAreNeighbors: __name(function allAreNeighbors(collection4) {
    collection4 = this.cy().collection(collection4);
  ...
  contains: __name(function contains(collection4) {
    collection4 = this.cy().collection(collection4);
    var self2 = this;
    return collection4.every(function(ele) {
...
var cache = __name(function cache2(fn3, name) {
  return __name(function traversalCache(arg1, arg2, arg3, arg4) {
...
var elesfn$f = {
  parent: __name(function parent(selector) {
    var parents2 = [];
    if (this.length === 1) {
  ...
  parents: __name(function parents(selector) {
    var parents2 = [];
  ...
  commonAncestors: __name(function commonAncestors(selector) {
    var ancestors;
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
  ...
  orphans: __name(function orphans(selector) {
    return this.stdFilter(function(ele) {
      return ele.isOrphan();
    }).filter(selector);
  }, "orphans"),
  nonorphans: __name(function nonorphans(selector) {
    return this.stdFilter(function(ele) {
      return ele.isChild();
    }).filter(selector);
  }, "nonorphans"),
  ...
  siblings: __name(function siblings(selector) {
    return this.parent().children().not(this).filter(selector);
  }, "siblings"),
  isParent: __name(function isParent() {
    var ele = this[0];
    if (ele) {
      return ele.isNode() && ele._private.children.length !== 0;
    }
  }, "isParent"),
  isChildless: __name(function isChildless() {
    var ele = this[0];
    if (ele) {
      return ele.isNode() && ele._private.children.length === 0;
    }
  }, "isChildless"),
  isChild: __name(function isChild() {
    var ele = this[0];
    if (ele) {
      return ele.isNode() && ele._private.parent != null;
    }
  }, "isChild"),
  isOrphan: __name(function isOrphan() {
    var ele = this[0];
    if (ele) {
      return ele.isNode() && ele._private.parent == null;
    }
  }, "isOrphan"),
  descendants: __name(function descendants(selector) {
    var elements = [];
    function add3(eles) {
      for (var i2 = 0; i2 < eles.length; i2++) {
        var ele = eles[i2];
...
extend(elesfn$d, {
  totalDegree: __name(function totalDegree(includeLoops) {
    var total = 0;
    var nodes3 = this.nodes();
    for (var i2 = 0; i2 < nodes3.length; i2++) {
...
var fn$4;
var elesfn$c;
var beforePositionSet = __name(function beforePositionSet2(eles, newPos, silent) {
  for (var i2 = 0; i2 < eles.length; i2++) {
    var ele = eles[i2];
    if (!ele.locked()) {
...
var positionDef = {
  ...
  allowGetting: true,
  validKeys: ["x", "y"],
  beforeGet: __name(function beforeGet(ele) {
    ele.updateCompoundBounds();
  }, "beforeGet"),
  beforeSet: __name(function beforeSet(eles, newPos) {
    beforePositionSet(eles, newPos, false);
  }, "beforeSet"),
  onSet: __name(function onSet(eles) {
    eles.dirtyCompoundBoundsCache();
  }, "onSet"),
  canSet: __name(function canSet(ele) {
    return !ele.locked();
  }, "canSet")
};
fn$4 = elesfn$c = {
  ...
  silentPosition: define.data(extend({}, positionDef, {
    ...
    settingTriggersEvent: false,
    allowGetting: false,
    beforeSet: __name(function beforeSet2(eles, newPos) {
      beforePositionSet(eles, newPos, true);
    }, "beforeSet"),
    onSet: __name(function onSet2(eles) {
      eles.dirtyCompoundBoundsCache();
    }, "onSet")
  })),
  positions: __name(function positions(pos, silent) {
    if (plainObject(pos)) {
      if (silent) {
  ...
  silentPositions: __name(function silentPositions(pos) {
    return this.positions(pos, true);
  }, "silentPositions"),
  shift: __name(function shift(dim, val, silent) {
    var delta;
    if (plainObject(dim)) {
      delta = {
  ...
  silentShift: __name(function silentShift(dim, val) {
    if (plainObject(dim)) {
      this.shift(dim, true);
    } else if (string(dim) && number$1(val)) {
  ...
  renderedPosition: __name(function renderedPosition(dim, val) {
    var ele = this[0];
    var cy = this.cy();
    var zoom2 = cy.zoom();
    var pan2 = cy.pan();
  ...
  relativePosition: __name(function relativePosition(dim, val) {
    var ele = this[0];
    var cy = this.cy();
...
var noninf = __name(function noninf2(x2) {
  if (x2 === Infinity || x2 === -Infinity) {
    return 0;
  }
  return x2;
}, "noninf");
var updateBounds = __name(function updateBounds2(b, x1, y1, x2, y2) {
  if (x2 - x1 === 0 || y2 - y1 === 0) {
    return;
  }
...
var updateBoundsFromBox = __name(function updateBoundsFromBox2(b, b2) {
  if (b2 == null) {
    return b;
  }
  return updateBounds(b, b2.x1, b2.y1, b2.x2, b2.y2);
}, "updateBoundsFromBox");
var prefixedProperty = __name(function prefixedProperty2(obj, field, prefix) {
  return getPrefixedProperty(obj, field, prefix);
}, "prefixedProperty");
var updateBoundsFromArrow = __name(function updateBoundsFromArrow2(bounds2, ele, prefix) {
  if (ele.cy().headless()) {
    return;
  }
  var _p = ele._private;
...
var updateBoundsFromLabel = __name(function updateBoundsFromLabel2(bounds2, ele, prefix) {
  if (ele.cy().headless()) {
    return;
  }
  var prefixDash;
  ...
  if (label) {
    ...
    if (isAutorotate || isPfValue) {
      ...
      var rotate2 = __name(function rotate3(x2, y2) {
        x2 = x2 - xo;
        y2 = y2 - yo;
        return {
...
var updateBoundsFromOutline = __name(function updateBoundsFromOutline2(bounds2, ele) {
  if (ele.cy().headless()) {
    return;
  }
...
var updateBoundsFromMiter = __name(function updateBoundsFromMiter2(bounds2, ele, opacity, expansionSize, expansionPosition, useFallbackValue) {
...
var updateBoundsFromMiterBorder = __name(function updateBoundsFromMiterBorder2(bounds2, ele) {
  if (ele.cy().headless()) {
    return;
  }
...
var boundingBoxImpl = __name(function boundingBoxImpl2(ele, options2) {
  ...
  var isDisplayed = __name(function isDisplayed2(ele2) {
...
var getKey = __name(function getKey2(opts) {
  var i2 = 0;
  var tf = __name(function tf2(val) {
    return (val ? 1 : 0) << i2++;
  }, "tf");
  var key = 0;
...
var getBoundingBoxPosKey = __name(function getBoundingBoxPosKey2(ele) {
  var r = __name(function r2(x2) {
...
var cachedBoundingBoxImpl = __name(function cachedBoundingBoxImpl2(ele, opts) {
  var _p = ele._private;
  var bb;
  var isEdge2 = ele.isEdge();
...
elesfn$b.boundingBoxAt = function(fn3) {
  ...
  if (plainObject(fn3)) {
    var obj = fn3;
    fn3 = __name(function fn4() {
      return obj;
    }, "fn");
  }
  var storeOldPos = __name(function storeOldPos2(node, i2) {
    return node._private.bbAtOldPos = fn3(node, i2);
  }, "storeOldPos");
  var getOldPos = __name(function getOldPos2(node) {
...
var elesfn$a;
fn$2 = elesfn$a = {};
var defineDimFns = __name(function defineDimFns2(opts) {
  opts.uppercaseName = capitalize(opts.name);
  opts.autoName = "auto" + opts.uppercaseName;
  opts.labelName = "label" + opts.uppercaseName;
  opts.outerName = "outer" + opts.uppercaseName;
  opts.uppercaseOuterName = capitalize(opts.outerName);
  fn$2[opts.name] = __name(function dimImpl() {
    var ele = this[0];
    var _p = ele._private;
    var cy = _p.cy;
  ...
  fn$2["outer" + opts.uppercaseName] = __name(function outerDimImpl() {
    var ele = this[0];
    var _p = ele._private;
    var cy = _p.cy;
    var styleEnabled2 = cy._private.styleEnabled;
  ...
  fn$2["rendered" + opts.uppercaseName] = __name(function renderedDimImpl() {
    var ele = this[0];
    if (ele) {
      var d = ele[opts.name]();
  ...
  fn$2["rendered" + opts.uppercaseOuterName] = __name(function renderedOuterDimImpl() {
    var ele = this[0];
    if (ele) {
...
var ifEdge = __name(function ifEdge2(ele, getValue2) {
  if (ele.isEdge() && ele.takesUpSpace()) {
    return getValue2(ele);
  }
}, "ifEdge");
var ifEdgeRenderedPosition = __name(function ifEdgeRenderedPosition2(ele, getPoint) {
  if (ele.isEdge() && ele.takesUpSpace()) {
    var cy = ele.cy();
    return modelToRenderedPosition$1(getPoint(ele), cy.zoom(), cy.pan());
  }
}, "ifEdgeRenderedPosition");
var ifEdgeRenderedPositions = __name(function ifEdgeRenderedPositions2(ele, getPoints) {
  if (ele.isEdge() && ele.takesUpSpace()) {
    var cy = ele.cy();
    var pan2 = cy.pan();
    var zoom2 = cy.zoom();
...
var controlPoints = __name(function controlPoints2(ele) {
  return ele.renderer().getControlPoints(ele);
}, "controlPoints");
var segmentPoints = __name(function segmentPoints2(ele) {
  return ele.renderer().getSegmentPoints(ele);
}, "segmentPoints");
var sourceEndpoint = __name(function sourceEndpoint2(ele) {
  return ele.renderer().getSourceEndpoint(ele);
}, "sourceEndpoint");
var targetEndpoint = __name(function targetEndpoint2(ele) {
  return ele.renderer().getTargetEndpoint(ele);
}, "targetEndpoint");
var midpoint = __name(function midpoint2(ele) {
...
var renderedName = __name(function renderedName2(name) {
...
var Event = __name(function Event2(src, props) {
...
Event.prototype = {
  instanceString: __name(function instanceString2() {
    return "event";
  }, "instanceString"),
  recycle: __name(function recycle(src, props) {
  ...
  stopPropagation: __name(function stopPropagation() {
  ...
  stopImmediatePropagation: __name(function stopImmediatePropagation() {
...
var defaults$8 = {
  qualifierCompare: __name(function qualifierCompare(q1, q2) {
    return q1 === q2;
  }, "qualifierCompare"),
  eventMatches: __name(function eventMatches() {
    return true;
  }, "eventMatches"),
  addEventFields: __name(function addEventFields() {
  }, "addEventFields"),
  callbackContext: __name(function callbackContext(context) {
    return context;
  }, "callbackContext"),
  beforeEmit: __name(function beforeEmit() {
  }, "beforeEmit"),
  afterEmit: __name(function afterEmit() {
  }, "afterEmit"),
  bubble: __name(function bubble() {
    return false;
  }, "bubble"),
  parent: __name(function parent2() {
    return null;
  }, "parent"),
  context: null
};
...
var forEachEvent = __name(function forEachEvent2(self2, handler, events, qualifier, callback, conf, confOverrides) {
  if (fn$6(qualifier)) {
    callback = qualifier;
    qualifier = null;
  }
...
var makeEventObj = __name(function makeEventObj2(self2, obj) {
  self2.addEventFields(self2.context, obj);
  return new Event(obj.type, obj);
}, "makeEventObj");
var forEachEventObj = __name(function forEachEventObj2(self2, handler, events) {
  if (event(events)) {
...
p.removeListener = p.off = function(events, qualifier, callback, conf) {
  ...
  var _loop = __name(function _loop2(i22) {
    var listener = listeners[i22];
...
p.emit = p.trigger = function(events, extraParams, manualCallback) {
  ...
  forEachEventObj(this, function(self2, eventObj) {
    ...
    var _loop2 = __name(function _loop22() {
...
var emitterOptions$1 = {
  qualifierCompare: __name(function qualifierCompare2(selector1, selector2) {
  ...
  eventMatches: __name(function eventMatches2(ele, listener, eventObj) {
  ...
  addEventFields: __name(function addEventFields2(ele, evt) {
    evt.cy = ele.cy();
    evt.target = ele;
  }, "addEventFields"),
  callbackContext: __name(function callbackContext2(ele, listener, eventObj) {
    return listener.qualifier != null ? eventObj.target : ele;
  }, "callbackContext"),
  beforeEmit: __name(function beforeEmit2(context, listener) {
    if (listener.conf && listener.conf.once) {
      listener.conf.onceCollection.removeListener(listener.event, listener.qualifier, listener.callback);
    }
  }, "beforeEmit"),
  bubble: __name(function bubble2() {
    return true;
  }, "bubble"),
  parent: __name(function parent3(ele) {
    return ele.isChild() ? ele.parent() : ele.cy();
  }, "parent")
};
var argSelector$1 = __name(function argSelector(arg) {
  if (string(arg)) {
...
var elesfn$9 = {
  createEmitter: __name(function createEmitter() {
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
      var _p = ele._private;
      if (!_p.emitter) {
  ...
  emitter: __name(function emitter() {
    return this._private.emitter;
  }, "emitter"),
  on: __name(function on(events, selector, callback) {
  ...
  removeListener: __name(function removeListener(events, selector, callback) {
    var argSel = argSelector$1(selector);
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
  ...
  removeAllListeners: __name(function removeAllListeners() {
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
  ...
  one: __name(function one(events, selector, callback) {
    var argSel = argSelector$1(selector);
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
  ...
  once: __name(function once(events, selector, callback) {
    var argSel = argSelector$1(selector);
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
      ele.emitter().on(events, argSel, callback, {
  ...
  emit: __name(function emit(events, extraParams) {
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
  ...
  emitAndNotify: __name(function emitAndNotify(event3, extraParams) {
    if (this.length === 0) {
      return;
    }
...
var elesfn$8 = {
  nodes: __name(function nodes(selector) {
    return this.filter(function(ele) {
      return ele.isNode();
    }).filter(selector);
  }, "nodes"),
  edges: __name(function edges(selector) {
    return this.filter(function(ele) {
      return ele.isEdge();
    }).filter(selector);
  }, "edges"),
  // internal helper to get nodes and edges as separate collections with single iteration over elements
  byGroup: __name(function byGroup() {
  ...
  filter: __name(function filter3(_filter, thisArg) {
    if (_filter === void 0) {
      return this;
  ...
  not: __name(function not(toRemove) {
    if (!toRemove) {
      return this;
    } else {
      if (string(toRemove)) {
  ...
  absoluteComplement: __name(function absoluteComplement() {
    var cy = this.cy();
    return cy.mutableElements().not(this);
  }, "absoluteComplement"),
  intersect: __name(function intersect(other) {
    if (string(other)) {
      var selector = other;
  ...
  xor: __name(function xor(other) {
    ...
    var col1 = this;
    var col2 = other;
    var add3 = __name(function add4(col, other2) {
  ...
  diff: __name(function diff(other) {
    var cy = this._private.cy;
    if (string(other)) {
      other = cy.$(other);
    }
    ...
    var col1 = this;
    var col2 = other;
    var add3 = __name(function add4(col, other2, retEles) {
      for (var i2 = 0; i2 < col.length; i2++) {
        var ele = col[i2];
        var id2 = ele._private.data.id;
        var inOther = other2.hasElementWithId(id2);
  ...
  merge: __name(function merge(toAdd) {
    var _p = this._private;
    var cy = _p.cy;
    if (!toAdd) {
      return this;
  ...
  unmergeAt: __name(function unmergeAt(i2) {
    var ele = this[i2];
    var id2 = ele.id();
    var _p = this._private;
    var map2 = _p.map;
  ...
  unmergeOne: __name(function unmergeOne(ele) {
    ele = ele[0];
    var _p = this._private;
    var id2 = ele._private.data.id;
    var map2 = _p.map;
  ...
  unmerge: __name(function unmerge(toRemove) {
    var cy = this._private.cy;
    if (!toRemove) {
      return this;
    }
  ...
  unmergeBy: __name(function unmergeBy(toRmFn) {
  ...
  map: __name(function map(mapFn, thisArg) {
    var arr = [];
    var eles = this;
    for (var i2 = 0; i2 < eles.length; i2++) {
      var ele = eles[i2];
  ...
  reduce: __name(function reduce(fn3, initialValue) {
  ...
  max: __name(function max4(valFn, thisArg) {
    var max5 = -Infinity;
    var maxEle;
    var eles = this;
    for (var i2 = 0; i2 < eles.length; i2++) {
  ...
  min: __name(function min3(valFn, thisArg) {
    var min4 = Infinity;
    var minEle;
    var eles = this;
    for (var i2 = 0; i2 < eles.length; i2++) {
...
var elesfn$7 = {
  isNode: __name(function isNode() {
    return this.group() === "nodes";
  }, "isNode"),
  isEdge: __name(function isEdge() {
    return this.group() === "edges";
  }, "isEdge"),
  isLoop: __name(function isLoop() {
    return this.isEdge() && this.source()[0] === this.target()[0];
  }, "isLoop"),
  isSimple: __name(function isSimple() {
    return this.isEdge() && this.source()[0] !== this.target()[0];
  }, "isSimple"),
  group: __name(function group() {
    var ele = this[0];
    if (ele) {
...
var zIndexSort = __name(function zIndexSort2(a, b) {
  var cy = a.cy();
  var hasCompoundNodes2 = cy.hasCompoundNodes();
...
var elesfn$6 = {
  forEach: __name(function forEach(fn3, thisArg) {
    if (fn$6(fn3)) {
      var N = this.length;
      for (var i2 = 0; i2 < N; i2++) {
        var ele = this[i2];
  ...
  slice: __name(function slice(start, end) {
    var array3 = [];
  ...
  size: __name(function size() {
    return this.length;
  }, "size"),
  eq: __name(function eq(i2) {
    return this[i2] || this.spawn();
  }, "eq"),
  first: __name(function first() {
    return this[0] || this.spawn();
  }, "first"),
  last: __name(function last() {
    return this[this.length - 1] || this.spawn();
  }, "last"),
  empty: __name(function empty() {
    return this.length === 0;
  }, "empty"),
  nonempty: __name(function nonempty() {
    return !this.empty();
  }, "nonempty"),
  sort: __name(function sort(sortFn) {
    if (!fn$6(sortFn)) {
      return this;
    }
  ...
  sortByZIndex: __name(function sortByZIndex() {
    return this.sort(zIndexSort);
  }, "sortByZIndex"),
  zDepth: __name(function zDepth() {
    var ele = this[0];
    if (!ele) {
      return void 0;
    }
...
var defineSymbolIterator = __name(function defineSymbolIterator2() {
...
var elesfn$5 = {
  ...
  layoutDimensions: __name(function layoutDimensions(options2) {
  ...
  layoutPositions: __name(function layoutPositions(layout4, options2, fn3) {
    var nodes3 = this.nodes().filter(function(n) {
      return !n.isParent();
    });
    var cy = this.cy();
    var layoutEles = options2.eles;
    var getMemoizeKey = __name(function getMemoizeKey2(node2) {
      return node2.id();
    }, "getMemoizeKey");
    ...
    layout4.animations = [];
    var calculateSpacing = __name(function calculateSpacing2(spacing, nodesBb, pos) {
      var center2 = {
    ...
    var spacingBb = __name(function spacingBb2() {
      if (!useSpacingFactor) {
        return null;
      }
      var bb2 = makeBoundingBox();
      for (var i22 = 0; i22 < nodes3.length; i22++) {
        var node2 = nodes3[i22];
        var pos = fnMem(node2, i22);
        expandBoundingBoxByPoint(bb2, pos.x, pos.y);
      }
      return bb2;
    }, "spacingBb");
    var bb = spacingBb();
    var getFinalPos = memoize(function(node2, i22) {
      var newPos2 = fnMem(node2, i22);
      if (useSpacingFactor) {
  ...
  layout: __name(function layout(options2) {
    var cy = this.cy();
...
function cacheStyleFunction(key, fn3) {
  key = hashString(key);
  return __name(function cachedStyleFunction(ele) {
...
function cachePrototypeStyleFunction(key, fn3) {
  key = hashString(key);
  var selfFn = __name(function selfFn2(ele) {
    return fn3.call(ele);
  }, "selfFn");
  return __name(function cachedPrototypeStyleFunction() {
    var ele = this[0];
    if (ele) {
...
var elesfn$4 = {
  recalculateRenderedStyle: __name(function recalculateRenderedStyle(useCache) {
    var cy = this.cy();
  ...
  dirtyStyleCache: __name(function dirtyStyleCache() {
    var cy = this.cy();
    var dirty = __name(function dirty2(ele) {
  ...
  updateStyle: __name(function updateStyle(notifyRenderer) {
    var cy = this._private.cy;
    if (!cy.styleEnabled()) {
      return this;
    }
  ...
  cleanStyle: __name(function cleanStyle() {
    var cy = this.cy();
    if (!cy.styleEnabled()) {
      return;
    }
  ...
  parsedStyle: __name(function parsedStyle(property) {
  ...
  numericStyle: __name(function numericStyle(property) {
    var ele = this[0];
  ...
  numericStyleUnits: __name(function numericStyleUnits(property) {
    var ele = this[0];
    if (!ele.cy().styleEnabled()) {
      return;
    }
  ...
  renderedStyle: __name(function renderedStyle(property) {
    var cy = this.cy();
    if (!cy.styleEnabled()) {
      return this;
    }
  ...
  style: __name(function style(name, value) {
    var cy = this.cy();
    if (!cy.styleEnabled()) {
      return this;
    }
  ...
  removeStyle: __name(function removeStyle(names) {
    var cy = this.cy();
    if (!cy.styleEnabled()) {
      return this;
    }
  ...
  show: __name(function show() {
    this.css("display", "element");
    return this;
  }, "show"),
  hide: __name(function hide() {
    this.css("display", "none");
    return this;
  }, "hide"),
  effectiveOpacity: __name(function effectiveOpacity() {
    var cy = this.cy();
    if (!cy.styleEnabled()) {
      return 1;
    }
  ...
  transparent: __name(function transparent() {
    var cy = this.cy();
    if (!cy.styleEnabled()) {
      return false;
    }
  ...
  backgrounding: __name(function backgrounding() {
    var cy = this.cy();
    if (!cy.styleEnabled()) {
      return false;
    }
...
defineSwitchSet({
  field: "locked",
  overrideField: __name(function overrideField(ele) {
...
defineSwitchSet({
  field: "grabbable",
  overrideField: __name(function overrideField2(ele) {
...
defineSwitchSet({
  ...
  overrideAble: __name(function overrideAble(ele) {
...
defineSwitchSet({
  field: "selectable",
  overrideField: __name(function overrideField3(ele) {
    return ele.cy().autounselectify() ? false : void 0;
  }, "overrideField"),
  on: "selectify",
  off: "unselectify"
...
var elesfn$2 = {};
var defineDagExtremity = __name(function defineDagExtremity2(params) {
  return __name(function dagExtremityImpl(selector) {
    var eles = this;
    var ret = [];
    for (var i2 = 0; i2 < eles.length; i2++) {
      var ele = eles[i2];
...
var defineDagOneHop = __name(function defineDagOneHop2(params) {
...
var defineDagAllHops = __name(function defineDagAllHops2(params) {
  return function(selector) {
    var eles = this;
    var sEles = [];
    var sElesIds = {};
...
extend(elesfn$2, {
  ...
  closedNeighborhood: __name(function closedNeighborhood(selector) {
    return this.neighborhood().add(this).filter(selector);
  }, "closedNeighborhood"),
  openNeighborhood: __name(function openNeighborhood(selector) {
...
extend(elesfn$2, {
  source: cache(__name(function sourceImpl(selector) {
    var ele = this[0];
    var src;
    if (ele) {
  ...
  target: cache(__name(function targetImpl(selector) {
    var ele = this[0];
    var tgt;
    if (ele) {
...
function defineSourceFunction(params) {
  return __name(function sourceImpl2(selector) {
    var sources = [];
    for (var i2 = 0; i2 < this.length; i2++) {
      var ele = this[i2];
...
function defineEdgesWithFunction(params) {
  return __name(function edgesWithImpl(otherNodes) {
    var elements = [];
    var cy = this._private.cy;
    var p2 = params || {};
...
function defineParallelEdgesFunction(params) {
  ...
  params = extend({}, defaults3, params);
  return __name(function parallelEdgesImpl(selector) {
    var elements = [];
    var edges3 = this.edges();
    var p2 = params;
    for (var i2 = 0; i2 < edges3.length; i2++) {
...
extend(elesfn$2, {
  components: __name(function components(root) {
    var self2 = this;
    var cy = self2.cy();
    ...
    var visitInComponent = __name(function visitInComponent2(node, component2) {
      visited.merge(node);
  ...
  component: __name(function component() {
    var ele = this[0];
    return ele.cy().mutableElements().components(ele)[0];
  }, "component")
});
elesfn$2.componentsOf = elesfn$2.components;
var Collection = __name(function Collection2(cy, elements) {
  ...
  this._private = {
    ...
    rebuildMap: __name(function rebuildMap() {
...
elesfn$1.json = function(obj) {
  ...
  if (plainObject(obj)) {
    ...
    var checkSwitch = __name(function checkSwitch2(k, trueFnName, falseFnName) {
      var obj_k = obj[k];
...
elesfn$1.restore = function() {
  ...
  var i2;
  var removeFromElements = __name(function removeFromElements2() {
...
elesfn$1.remove = function() {
  ...
  function addConnectedEdges(node) {
    var edges3 = node._private.edges;
    for (var i22 = 0; i22 < edges3.length; i22++) {
      add3(edges3[i22]);
    }
  }
...
elesfn$1.move = function(struct) {
  ...
  var toString3 = __name(function toString4(id2) {
...
var corefn$9 = {
  ...
  remove: __name(function remove(collection4) {
...
function generateCubicBezier(mX1, mY1, mX2, mY2) {
  ...
  function binarySubdivide(aX, aA, aB) {
    ...
    } while (Math.abs(currentX) > SUBDIVISION_PRECISION && ++i22 < SUBDIVISION_MAX_ITERATIONS);
    return currentT;
  }
...
var generateSpringRK4 = (function() {
  ...
  return __name(function springRK4Factory(tension, friction, duration) {
    var initState = {
      x: -1,
      v: 0,
      tension: null,
...
var cubicBezier = __name(function cubicBezier2(t1, p1, t2, p2) {
...
var easings = {
  "linear": __name(function linear(start, end, percent) {
  ...
  // user param easings...
  "spring": __name(function spring(tension, friction, duration) {
    if (duration === 0) {
...
function stepAll(now, cy) {
  ...
  function stepOne(ele2, isCore) {
    ...
    var callbacks = __name(function callbacks2(_callbacks) {
...
var corefn$8 = {
  ...
  delayAnimation: define.delayAnimation(),
  stop: define.stop(),
  addToAnimationPool: __name(function addToAnimationPool(eles) {
    var cy = this;
    if (!cy.styleEnabled()) {
      return;
    }
  ...
  stopAnimationLoop: __name(function stopAnimationLoop() {
    this._private.animationsRunning = false;
  }, "stopAnimationLoop"),
  startAnimationLoop: __name(function startAnimationLoop() {
    var cy = this;
    ...
    function headlessStep() {
      ...
      requestAnimationFrame(__name(function animationStep(now) {
        stepAll(now, cy);
        headlessStep();
      }, "animationStep"));
    }
    ...
    if (renderer3 && renderer3.beforeRender) {
      renderer3.beforeRender(__name(function rendererAnimationStep(willDraw, now) {
        stepAll(now, cy);
...
var emitterOptions = {
  qualifierCompare: __name(function qualifierCompare3(selector1, selector2) {
    if (selector1 == null || selector2 == null) {
      return selector1 == null && selector2 == null;
    } else {
      return selector1.sameText(selector2);
  ...
  eventMatches: __name(function eventMatches3(cy, listener, eventObj) {
    var selector = listener.qualifier;
    if (selector != null) {
  ...
  addEventFields: __name(function addEventFields3(cy, evt) {
    evt.cy = cy;
    evt.target = cy;
  }, "addEventFields"),
  callbackContext: __name(function callbackContext3(cy, listener, eventObj) {
    return listener.qualifier != null ? eventObj.target : cy;
  }, "callbackContext")
};
var argSelector2 = __name(function argSelector3(arg) {
  if (string(arg)) {
    return new Selector(arg);
  } else {
    return arg;
...
var elesfn = {
  createEmitter: __name(function createEmitter2() {
    var _p = this._private;
    if (!_p.emitter) {
  ...
  emitter: __name(function emitter2() {
    return this._private.emitter;
  }, "emitter"),
  on: __name(function on2(events, selector, callback) {
    this.emitter().on(events, argSelector2(selector), callback);
    return this;
  }, "on"),
  removeListener: __name(function removeListener2(events, selector, callback) {
    this.emitter().removeListener(events, argSelector2(selector), callback);
    return this;
  }, "removeListener"),
  removeAllListeners: __name(function removeAllListeners2() {
    this.emitter().removeAllListeners();
    return this;
  }, "removeAllListeners"),
  one: __name(function one2(events, selector, callback) {
    this.emitter().one(events, argSelector2(selector), callback);
    return this;
  }, "one"),
  once: __name(function once2(events, selector, callback) {
    this.emitter().one(events, argSelector2(selector), callback);
    return this;
  }, "once"),
  emit: __name(function emit2(events, extraParams) {
    this.emitter().emit(events, extraParams);
    return this;
  }, "emit"),
  emitAndNotify: __name(function emitAndNotify2(event3, eles) {
    this.emit(event3);
...
var corefn$6 = {
  layout: __name(function layout2(options2) {
    var cy = this;
    if (options2 == null) {
...
var corefn$5 = {
  notify: __name(function notify(eventName, eventEles) {
    var _p = this._private;
    if (this.batching()) {
  ...
  notifications: __name(function notifications(bool) {
  ...
  noNotifications: __name(function noNotifications(callback) {
    this.notifications(false);
    callback();
    this.notifications(true);
  }, "noNotifications"),
  batching: __name(function batching() {
    return this._private.batchCount > 0;
  }, "batching"),
  startBatch: __name(function startBatch() {
    var _p = this._private;
  ...
  endBatch: __name(function endBatch() {
    var _p = this._private;
    if (_p.batchCount === 0) {
      return this;
    }
  ...
  batch: __name(function batch(callback) {
    this.startBatch();
    callback();
    this.endBatch();
    return this;
  ...
  batchData: __name(function batchData(map2) {
    var cy = this;
...
var corefn$4 = {
  renderTo: __name(function renderTo(context, zoom2, pan2, pxRatio) {
    var r = this._private.renderer;
    r.renderTo(context, zoom2, pan2, pxRatio);
    return this;
  }, "renderTo"),
  renderer: __name(function renderer() {
    return this._private.renderer;
  }, "renderer"),
  forceRender: __name(function forceRender() {
    this.notify("draw");
    return this;
  }, "forceRender"),
  resize: __name(function resize() {
    this.invalidateSize();
    this.emitAndNotify("resize");
    return this;
  }, "resize"),
  initRenderer: __name(function initRenderer(options2) {
    var cy = this;
  ...
  destroyRenderer: __name(function destroyRenderer() {
    var cy = this;
    cy.notify("destroy");
  ...
  onRender: __name(function onRender(fn3) {
    return this.on("render", fn3);
  }, "onRender"),
  offRender: __name(function offRender(fn3) {
...
var corefn$3 = {
  ...
  collection: __name(function collection3(eles, opts) {
    if (string(eles)) {
      return this.$(eles);
  ...
  nodes: __name(function nodes2(selector) {
  ...
  edges: __name(function edges2(selector) {
  ...
  mutableElements: __name(function mutableElements() {
...
styfn$8.updateStyleHints = function(ele) {
  ...
  var propHash = __name(function propHash2(ele2, propNames2, seedKey) {
  ...
  var updateGrKey1 = __name(function updateGrKey12(val, grKey2) {
    return _p.styleKeys[grKey2][0] = hashInt(val, _p.styleKeys[grKey2][0]);
  }, "updateGrKey1");
  var updateGrKey2 = __name(function updateGrKey22(val, grKey2) {
    return _p.styleKeys[grKey2][1] = hashIntAlt(val, _p.styleKeys[grKey2][1]);
  }, "updateGrKey2");
  var updateGrKey = __name(function updateGrKey3(val, grKey2) {
    updateGrKey1(val, grKey2);
    updateGrKey2(val, grKey2);
  }, "updateGrKey");
  var updateGrKeyWStr = __name(function updateGrKeyWStr2(strVal, grKey2) {
  ...
  var N = 2e9;
  var cleanNum = __name(function cleanNum2(val) {
...
styfn$8.applyParsedProperty = function(ele, parsedProp) {
  ...
  var getVal = __name(function getVal2(p2) {
    if (p2 == null) {
      return null;
  ...
  var checkTriggers = __name(function checkTriggers2() {
  ...
  var printMappingErr = __name(function printMappingErr2() {
  ...
  if (ele) {
    ...
    if (styleProp) {
      ...
      if (isRenderedVal && type.number && value != null && number$1(value)) {
        ...
        var getRenderedValue = __name(function getRenderedValue2(val) {
          return val * zoom2;
        }, "getRenderedValue");
        var getValueStringWithUnits = __name(function getValueStringWithUnits2(val, units2) {
...
(function() {
  ...
  var hex3$1 = hex3;
  var hex6$1 = hex6;
  var data4 = __name(function data5(prefix) {
    return "^" + prefix + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
  }, "data");
  var mapData = __name(function mapData2(prefix) {
  ...
  styfn$2.types = {
    ...
    edgeEndpoint: {
      ...
      singleEnum: true,
      validate: __name(function validate(valArr, unitsArr) {
    ...
    boundsExpansion: {
      ...
      multiple: true,
      min: 0,
      validate: __name(function validate(valArr) {
  ...
  var diff2 = {
    zeroNonZero: __name(function zeroNonZero(val1, val2) {
    ...
    any: __name(function any(val1, val2) {
      return val1 != val2;
    }, "any"),
    emptyNonEmpty: __name(function emptyNonEmpty(str1, str2) {
  ...
  var visibility = [{
    ...
    triggersBoundsOfParallelEdges: __name(function triggersBoundsOfParallelEdges(fromValue, toValue, ele) {
  ...
  var nodeSizeHashOverride = __name(function nodeSizeHashOverride2(ele, parsedProp) {
  ...
  var edgeLine = [{
    ...
    type: t.curveStyle,
    triggersBounds: diff2.any,
    triggersBoundsOfParallelEdges: __name(function triggersBoundsOfParallelEdges(fromValue, toValue) {
      if (fromValue === toValue) {
        return false;
      }
...
styfn$2.getDefaultProperties = function() {
  ...
  var rawProps = extend({
    ...
    for (var i22 = 1; i22 <= styfn$2.pieBackgroundN; i22++) {
      var name2 = prop2.name.replace("{{i}}", i22);
    ...
    for (var i22 = 1; i22 <= styfn$2.stripeBackgroundN; i22++) {
      var name2 = prop2.name.replace("{{i}}", i22);
      var val2 = prop2.value;
      css[name2] = val2;
    }
...
styfn$1.parseImpl = function(name, value, propIsBypass, propIsFlat) {
  ...
  var checkEnums = __name(function checkEnums2() {
...
var _Style = __name(function Style(cy) {
...
var corefn$2 = {
  style: __name(function style2(newStyle) {
    if (newStyle) {
  ...
  setStyle: __name(function setStyle(style3) {
    var _p = this._private;
    if (stylesheet(style3)) {
  ...
  updateStyle: __name(function updateStyle2() {
    this.mutableElements().updateStyle();
  }, "updateStyle")
};
var defaultSelectionType = "single";
var corefn$1 = {
  autolock: __name(function autolock(bool) {
    if (bool !== void 0) {
  ...
  autoungrabify: __name(function autoungrabify(bool) {
    if (bool !== void 0) {
  ...
  autounselectify: __name(function autounselectify(bool) {
    if (bool !== void 0) {
  ...
  selectionType: __name(function selectionType(selType) {
    var _p = this._private;
  ...
  panningEnabled: __name(function panningEnabled(bool) {
    if (bool !== void 0) {
  ...
  userPanningEnabled: __name(function userPanningEnabled(bool) {
    if (bool !== void 0) {
  ...
  zoomingEnabled: __name(function zoomingEnabled(bool) {
    if (bool !== void 0) {
  ...
  userZoomingEnabled: __name(function userZoomingEnabled(bool) {
    if (bool !== void 0) {
  ...
  boxSelectionEnabled: __name(function boxSelectionEnabled(bool) {
    if (bool !== void 0) {
  ...
  panBy: __name(function panBy(arg0, arg1) {
    var args = arguments;
    var pan2 = this._private.pan;
    var dim, val, dims, x2, y2;
    if (!this._private.panningEnabled) {
  ...
  gc: __name(function gc() {
    this.notify("gc");
  }, "gc"),
  fit: __name(function fit(elements, padding) {
  ...
  getFitViewport: __name(function getFitViewport(elements, padding) {
  ...
  zoomRange: __name(function zoomRange(min4, max5) {
    var _p = this._private;
    if (max5 == null) {
      var opts = min4;
      min4 = opts.min;
  ...
  minZoom: __name(function minZoom(zoom2) {
    if (zoom2 === void 0) {
  ...
  maxZoom: __name(function maxZoom(zoom2) {
    if (zoom2 === void 0) {
  ...
  getZoomedViewport: __name(function getZoomedViewport(params) {
    var _p = this._private;
  ...
  zoom: __name(function zoom(params) {
    if (params === void 0) {
  ...
  viewport: __name(function viewport(opts) {
    var _p = this._private;
    var zoomDefd = true;
    var panDefd = true;
    var events = [];
  ...
  center: __name(function center(elements) {
  ...
  getCenterPan: __name(function getCenterPan(elements, zoom2) {
    if (!this._private.panningEnabled) {
      return;
    }
    if (string(elements)) {
  ...
  invalidateSize: __name(function invalidateSize() {
    this._private.sizeCache = null;
  }, "invalidateSize"),
  size: __name(function size2() {
    var _p = this._private;
    ...
    return _p.sizeCache = _p.sizeCache || (container2 ? (function() {
      ...
      var val = __name(function val2(name) {
  ...
  width: __name(function width() {
    return this.size().width;
  }, "width"),
  height: __name(function height() {
    return this.size().height;
  }, "height"),
  extent: __name(function extent() {
    var pan2 = this._private.pan;
  ...
  renderedExtent: __name(function renderedExtent() {
  ...
  multiClickDebounceTime: __name(function multiClickDebounceTime(_int) {
...
var Core = __name(function Core2(opts) {
  var cy = this;
  opts = extend({}, opts);
  ...
  var defVal = __name(function defVal2(def, val, altVal) {
    if (val !== void 0) {
      return val;
  ...
  var loadExtData = __name(function loadExtData2(extData, next) {
  ...
  var setElesAndLayout = __name(function setElesAndLayout2(elements, onload, ondone) {
...
extend(corefn, {
  instanceString: __name(function instanceString3() {
    return "core";
  }, "instanceString"),
  isReady: __name(function isReady() {
    return this._private.ready;
  }, "isReady"),
  destroyed: __name(function destroyed() {
    return this._private.destroyed;
  }, "destroyed"),
  ready: __name(function ready(fn3) {
    if (this.isReady()) {
  ...
  hasElementWithId: __name(function hasElementWithId(id2) {
    return this._private.elements.hasElementWithId(id2);
  }, "hasElementWithId"),
  getElementById: __name(function getElementById(id2) {
    return this._private.elements.getElementById(id2);
  }, "getElementById"),
  hasCompoundNodes: __name(function hasCompoundNodes() {
    return this._private.hasCompoundNodes;
  }, "hasCompoundNodes"),
  headless: __name(function headless() {
    return this._private.renderer.isHeadless();
  }, "headless"),
  styleEnabled: __name(function styleEnabled() {
    return this._private.styleEnabled;
  }, "styleEnabled"),
  addToPool: __name(function addToPool(eles) {
    this._private.elements.merge(eles);
    return this;
  }, "addToPool"),
  removeFromPool: __name(function removeFromPool(eles) {
    this._private.elements.unmerge(eles);
    return this;
  }, "removeFromPool"),
  container: __name(function container() {
  ...
  mount: __name(function mount(container2) {
    if (container2 == null) {
      return;
    }
    var cy = this;
  ...
  unmount: __name(function unmount() {
    var cy = this;
    cy.stopAnimationLoop();
    cy.destroyRenderer();
    cy.initRenderer({
  ...
  options: __name(function options() {
    return copy(this._private.options);
  }, "options"),
  json: __name(function json(obj) {
    var cy = this;
    var _p = cy._private;
    var eles = cy.mutableElements();
    var getFreshRef = __name(function getFreshRef2(ele) {
    ...
    if (plainObject(obj)) {
      ...
      if (obj.elements) {
        var idInJson = {};
        var updateEles = __name(function updateEles2(jsons, gr2) {
          var toAdd = [];
          var toMod = [];
          for (var i22 = 0; i22 < jsons.length; i22++) {
            var json3 = jsons[i22];
            if (!json3.data.id) {
...
var defaults$7 = {
  ...
  animateFilter: __name(function animateFilter(node, i2) {
    return true;
  }, "animateFilter"),
  ...
  transform: __name(function transform(node, position3) {
    return position3;
  }, "transform")
...
var getInfo = __name(function getInfo2(ele) {
  return ele.scratch("breadthfirst");
}, "getInfo");
var setInfo = __name(function setInfo2(ele, obj) {
...
BreadthFirstLayout.prototype.run = function() {
  ...
  var depths = [];
  var foundByBfs = {};
  var addToDepth = __name(function addToDepth2(ele2, d) {
    if (depths[d] == null) {
      depths[d] = [];
    }
    var i22 = depths[d].length;
    depths[d].push(ele2);
    setInfo(ele2, {
      index: i22,
      depth: d
  ...
  var changeDepth = __name(function changeDepth2(ele2, newDepth) {
  ...
  graph.bfs({
    roots,
    directed: options2.directed,
    visit: __name(function visit(node, edge, pNode, i22, depth) {
      var ele2 = node[0];
      var id3 = ele2.id();
  ...
  var assignDepthsAt = __name(function assignDepthsAt2(i22) {
    var eles2 = depths[i22];
  ...
  var adjustMaximally = __name(function adjustMaximally2(ele2, shifted2) {
  ...
  if (directed && maximal) {
    var Q = [];
    var shifted = {};
    var enqueue = __name(function enqueue2(n2) {
      return Q.push(n2);
    }, "enqueue");
    var dequeue = __name(function dequeue2() {
      return Q.shift();
    }, "dequeue");
  ...
  var getWeightedPercent = __name(function getWeightedPercent2(ele2) {
  ...
  var sortFn = __name(function sortFn2(a, b) {
  ...
  var assignDepths = __name(function assignDepths2() {
  ...
  var getPositionTopBottom = __name(function getPositionTopBottom2(ele2) {
  ...
  var getPosition = __name(function getPosition2(ele2) {
...
var defaults$6 = {
  ...
  animationEasing: void 0,
  // easing of animation if enabled
  animateFilter: __name(function animateFilter2(node, i2) {
    return true;
  }, "animateFilter"),
  // a function that determines whether the node should be animated.  All nodes animated by default on animate enabled.  Non-animated nodes are positioned immediately when the layout starts
  ready: void 0,
  ...
  stop: void 0,
  // callback on layoutstop
  transform: __name(function transform2(node, position3) {
    return position3;
  }, "transform")
  // transform a given node position. Useful for changing flow direction in discrete layouts 
};
...
CircleLayout.prototype.run = function() {
  ...
  var getPos = __name(function getPos2(ele, i22) {
    var theta = options2.startAngle + i22 * dTheta * (clockwise ? 1 : -1);
...
var defaults$5 = {
  ...
  spacingFactor: void 0,
  // Applies a multiplicative factor (>0) to expand or compress the overall area that the nodes take up
  concentric: __name(function concentric(node) {
    return node.degree();
  }, "concentric"),
  levelWidth: __name(function levelWidth(nodes3) {
  ...
  animationEasing: void 0,
  // easing of animation if enabled
  animateFilter: __name(function animateFilter3(node, i2) {
    return true;
  }, "animateFilter"),
  // a function that determines whether the node should be animated.  All nodes animated by default on animate enabled.  Non-animated nodes are positioned immediately when the layout starts
  ready: void 0,
  ...
  stop: void 0,
  // callback on layoutstop
  transform: __name(function transform3(node, position3) {
    return position3;
  }, "transform")
  // transform a given node position. Useful for changing flow direction in discrete layouts
};
...
var defaults$4 = {
  ...
  ready: __name(function ready2() {
  }, "ready"),
  // Called on `layoutstop`
  stop: __name(function stop3() {
  }, "stop"),
  ...
  animateFilter: __name(function animateFilter4(node, i2) {
    return true;
  }, "animateFilter"),
  ...
  nodeRepulsion: __name(function nodeRepulsion(node) {
    return 2048;
  }, "nodeRepulsion"),
  // Node repulsion (overlapping) multiplier
  nodeOverlap: 4,
  // Ideal edge (non nested) length
  idealEdgeLength: __name(function idealEdgeLength(edge) {
    return 32;
  }, "idealEdgeLength"),
  // Divisor to compute edge forces
  edgeElasticity: __name(function edgeElasticity(edge) {
    return 32;
  }, "edgeElasticity"),
...
CoseLayout.prototype.run = function() {
  ...
  var refresh = __name(function refresh2() {
    refreshPositions(layoutInfo, cy, options2);
    if (true === options2.fit) {
      cy.fit(options2.padding);
    }
  }, "refresh");
  var mainLoop = __name(function mainLoop2(i22) {
    if (layout4.stopped || i22 >= options2.numIter) {
      return false;
    }
  ...
  var done = __name(function done2() {
    if (options2.animate === true || options2.animate === false) {
      refresh();
      layout4.one("layoutstop", options2.stop);
      layout4.emit({
  ...
  if (options2.animate === true) {
    var _frame = __name(function frame() {
      var f = 0;
...
var createLayoutInfo = __name(function createLayoutInfo2(cy, layout4, options2) {
...
var findLCA = __name(function findLCA2(node1, node2, layoutInfo) {
...
var _findLCA_aux = __name(function findLCA_aux(node1, node2, graphIx, layoutInfo) {
...
var printLayoutInfo;
var randomizePositions = __name(function randomizePositions2(layoutInfo, cy) {
...
var getScaleInBoundsFn = __name(function getScaleInBoundsFn2(layoutInfo, options2, nodes3) {
...
var refreshPositions = __name(function refreshPositions2(layoutInfo, cy, options2) {
...
var step = __name(function step2(layoutInfo, options2, _step) {
...
var calculateNodeForces = __name(function calculateNodeForces2(layoutInfo, options2) {
  for (var i2 = 0; i2 < layoutInfo.graphSet.length; i2++) {
    var graph = layoutInfo.graphSet[i2];
...
var randomDistance = __name(function randomDistance2(max5) {
  return -1 + 2 * max5 * Math.random();
}, "randomDistance");
var nodeRepulsion2 = __name(function nodeRepulsion3(node1, node2, layoutInfo, options2) {
...
var nodesOverlap = __name(function nodesOverlap2(node1, node2, dX, dY) {
  if (dX > 0) {
...
var findClippingPoint = __name(function findClippingPoint2(node, dX, dY) {
...
var calculateEdgeForces = __name(function calculateEdgeForces2(layoutInfo, options2) {
  for (var i2 = 0; i2 < layoutInfo.edgeSize; i2++) {
...
var calculateGravityForces = __name(function calculateGravityForces2(layoutInfo, options2) {
...
var propagateForces = __name(function propagateForces2(layoutInfo, options2) {
  var queue = [];
  var start = 0;
  var end = -1;
...
var updatePositions = __name(function updatePositions2(layoutInfo, options2) {
  for (var i2 = 0; i2 < layoutInfo.nodeSize; i2++) {
    var n = layoutInfo.layoutNodes[i2];
...
var limitForce = __name(function limitForce2(forceX, forceY, max5) {
...
var _updateAncestryBoundaries = __name(function updateAncestryBoundaries(node, layoutInfo) {
...
var separateComponents = __name(function separateComponents2(layoutInfo, options2) {
...
var defaults$3 = {
  ...
  position: __name(function position2(node) {
  }, "position"),
  ...
  animationEasing: void 0,
  // easing of animation if enabled
  animateFilter: __name(function animateFilter5(node, i2) {
    return true;
  }, "animateFilter"),
  // a function that determines whether the node should be animated.  All nodes animated by default on animate enabled.  Non-animated nodes are positioned immediately when the layout starts
  ready: void 0,
  ...
  stop: void 0,
  // callback on layoutstop
  transform: __name(function transform4(node, position3) {
    return position3;
  }, "transform")
  // transform a given node position. Useful for changing flow direction in discrete layouts 
};
...
GridLayout.prototype.run = function() {
  ...
  if (bb.h === 0 || bb.w === 0) {
    ...
    var small = __name(function small2(val) {
      if (val == null) {
    ...
    var large = __name(function large2(val) {
      if (val == null) {
    ...
    var cellUsed = {};
    var used = __name(function used2(row2, col2) {
      return cellUsed["c-" + row2 + "-" + col2] ? true : false;
    }, "used");
    var use = __name(function use2(row2, col2) {
      cellUsed["c-" + row2 + "-" + col2] = true;
    }, "use");
    var row = 0;
    var col = 0;
    var moveToNextCell = __name(function moveToNextCell2() {
      col++;
      if (col >= cols) {
        col = 0;
        row++;
    ...
    var getPos = __name(function getPos2(element3, i22) {
      var x2, y2;
...
var defaults$2 = {
  ready: __name(function ready3() {
  }, "ready"),
  // on layoutready
  stop: __name(function stop4() {
  }, "stop")
  // on layoutstop
};
...
var defaults$1 = {
  ...
  animationEasing: void 0,
  // easing of animation if enabled
  animateFilter: __name(function animateFilter6(node, i2) {
    return true;
  }, "animateFilter"),
  // a function that determines whether the node should be animated.  All nodes animated by default on animate enabled.  Non-animated nodes are positioned immediately when the layout starts
  ready: void 0,
  ...
  stop: void 0,
  // callback on layoutstop
  transform: __name(function transform5(node, position3) {
    return position3;
  }, "transform")
  // transform a given node position. Useful for changing flow direction in discrete layouts
};
...
var defaults2 = {
  ...
  animationEasing: void 0,
  // easing of animation if enabled
  animateFilter: __name(function animateFilter7(node, i2) {
    return true;
  }, "animateFilter"),
  // a function that determines whether the node should be animated.  All nodes animated by default on animate enabled.  Non-animated nodes are positioned immediately when the layout starts
  ready: void 0,
  ...
  stop: void 0,
  // callback on layoutstop
  transform: __name(function transform6(node, position3) {
    return position3;
  }, "transform")
  // transform a given node position. Useful for changing flow direction in discrete layouts 
};
...
RandomLayout.prototype.run = function() {
  ...
  var getPos = __name(function getPos2(node, i2) {
    return {
...
var noop2 = __name(function noop3() {
}, "noop");
var throwImgErr = __name(function throwImgErr2() {
  throw new Error("A headless instance can not render images");
}, "throwImgErr");
NullRenderer.prototype = {
  recalculateRenderedStyle: noop2,
  notify: __name(function notify2() {
    this.notifications++;
  }, "notify"),
  init: noop2,
  isHeadless: __name(function isHeadless() {
    return true;
  }, "isHeadless"),
  png: throwImgErr,
  jpg: throwImgErr
...
BRp$f.registerArrowShapes = function() {
  ...
  var renderer3 = this;
  var bbCollide = __name(function bbCollide2(x2, y2, size3, angle2, translation, edgeWidth, padding) {
  ...
  var transform7 = __name(function transform8(x2, y2, size3, angle2, translation) {
  ...
  var transformPoints3 = __name(function transformPoints4(pts2, size3, angle2, translation) {
    var retPts = [];
  ...
  var pointsToArr = __name(function pointsToArr2(pts2) {
    var ret = [];
  ...
  var standardGap = __name(function standardGap2(edge) {
    return edge.pstyle("width").pfValue * edge.pstyle("arrow-scale").pfValue * 2;
  }, "standardGap");
  var defineArrowShape = __name(function defineArrowShape2(name, defn) {
    if (string(defn)) {
    ...
    arrowShapes[name] = extend({
      ...
      collide: __name(function collide(x2, y2, size3, angle2, translation, padding) {
  ...
  defineArrowShape("triangle-backcurve", {
    ...
    controlPoint: [0, -0.15],
    roughCollide: bbCollide,
    draw: __name(function draw(context, size3, angle2, translation, edgeWidth) {
  ...
  defineArrowShape("triangle-tee", {
    ...
    collide: __name(function collide(x2, y2, size3, angle2, translation, edgeWidth, padding) {
  ...
  defineArrowShape("triangle-cross", {
    ...
    crossLinePts: __name(function crossLinePts(size3, edgeWidth) {
...
BRp$e.findContainerClientCoords = function() {
  ...
  var styleValue = __name(function styleValue2(name) {
    return parseFloat(style3.getPropertyValue(name));
  }, "styleValue");
  var padding = {
...
BRp$e.findNearestElements = function(x2, y2, interactiveElementsOnly, isTouch) {
    ...
    if (ele2.isEdge() && (sqDist == null || sqDist < minSqDist)) {
      if (nearEdge) {
        if (nearEdge.pstyle("z-compound-depth").value === ele2.pstyle("z-compound-depth").value && nearEdge.pstyle("z-compound-depth").value === ele2.pstyle("z-compound-depth").value) {
          for (var i22 = 0; i22 < near.length; i22++) {
            if (near[i22].isEdge()) {
              near[i22] = ele2;
              nearEdge = ele2;
  ...
  function checkEdge(edge) {
    ...
    if (rs.edgeType === "segments" || rs.edgeType === "straight" || rs.edgeType === "haystack") {
      var pts2 = rs.allpts;
      for (var i22 = 0; i22 + 3 < pts2.length; i22 += 2) {
        if (inLineVicinity(x2, y2, pts2[i22], pts2[i22 + 1], pts2[i22 + 2], pts2[i22 + 3], width22) && widthSq > (sqDist = sqdistToFiniteLine(x2, y2, pts2[i22], pts2[i22 + 1], pts2[i22 + 2], pts2[i22 + 3]))) {
          addEle(edge, sqDist);
          return true;
        }
      }
      ...
      var pts2 = rs.allpts;
      for (var i22 = 0; i22 + 5 < rs.allpts.length; i22 += 4) {
        if (inBezierVicinity(x2, y2, pts2[i22], pts2[i22 + 1], pts2[i22 + 2], pts2[i22 + 3], pts2[i22 + 4], pts2[i22 + 5], width22) && widthSq > (sqDist = sqdistToQuadraticBezier(x2, y2, pts2[i22], pts2[i22 + 1], pts2[i22 + 2], pts2[i22 + 3], pts2[i22 + 4], pts2[i22 + 5]))) {
          addEle(edge, sqDist);
          return true;
        }
      }
    ...
    for (var i22 = 0; i22 < arrows.length; i22++) {
      var ar = arrows[i22];
  ...
  function checkLabel(ele2, prefix) {
    ...
    if (theta) {
      var cos2 = Math.cos(theta);
      var sin2 = Math.sin(theta);
      var rotate2 = __name(function rotate3(x3, y3) {
        x3 = x3 - lx;
        y3 = y3 - ly;
        return {
...
var stopY;
var lastPoint;
var asVec = __name(function asVec2(p2, pp, v) {
  v.x = pp.x - p2.x;
  v.y = pp.y - p2.y;
...
var invertVec = __name(function invertVec2(originalV, invertedV) {
...
var calcCornerArc = __name(function calcCornerArc2(previousPoint, currentPoint, nextPoint, radiusMax, isArcRadius) {
...
BRp$c.findMidptPtsEtc = function(edge, pairInfo) {
  ...
  var recalcVectorNormInverse = __name(function recalcVectorNormInverse2(x12, y12, x22, y22) {
    var dy = y22 - y12;
    var dx = x22 - x12;
...
BRp$c.findTaxiPoints = function(edge, pairInfo) {
  ...
  var subDWH = __name(function subDWH2(dxy, dwh) {
    if (dxy > 0) {
  ...
  var getIsTooClose = __name(function getIsTooClose2(d2) {
...
BRp$c.findEdgeControlPoints = function(edges3) {
  ...
  var getKey3 = __name(function getKey4(pairId2, edgeIsUnbundled2) {
...
function pushBezierPts(r, edge, pts2) {
  var qbezierAt$1 = __name(function qbezierAt$12(p1, p22, p3, t) {
...
var lineAngleFromDelta = __name(function lineAngleFromDelta2(dx, dy) {
...
var lineAngle = __name(function lineAngle2(p0, p1) {
  var dx = p1.x - p0.x;
  var dy = p1.y - p0.y;
  return lineAngleFromDelta(dx, dy);
}, "lineAngle");
var bezierAngle = __name(function bezierAngle2(p0, p1, p2, t) {
...
BRp$9.recalculateEdgeLabelProjections = function(edge) {
  ...
  var setRs = __name(function setRs2(propName, prefix, value) {
  ...
  var _createControlPointInfo = __name(function createControlPointInfo() {
  ...
  var calculateEndProjection = __name(function calculateEndProjection2(prefix) {
    var angle2;
...
BRp$9.getLabelText = function(ele, prefix) {
  ...
  var rscratch = __name(function rscratch2(propName, value) {
    if (value) {
      setPrefixedProperty(_p.rscratch, propName, prefix, value);
      return value;
    } else {
...
BRp$7.registerCalculationListeners = function() {
  ...
  var r = this;
  var enqueue = __name(function enqueue2(eles) {
  ...
  r.binder(cy).on("bounds.* dirty.*", __name(function onDirtyBounds(e) {
    var ele = e.target;
    enqueue(ele);
  }, "onDirtyBounds")).on("style.* background.*", __name(function onDirtyStyle(e) {
    var ele = e.target;
    enqueue(ele, false);
  }, "onDirtyStyle"));
  var updateEleCalcs = __name(function updateEleCalcs2(willDraw) {
    if (willDraw) {
...
BRp$7.recalculateRenderedStyle = function(eles, useCache) {
  var isCleanConnected = __name(function isCleanConnected2(ele2) {
...
BRp$3.binder = function(tgt) {
  ...
  var on3 = __name(function on4(event3, handler, useCapture) {
...
BRp$3.load = function() {
  var r = this;
  var containerWindow = r.cy.window();
  var isSelected = __name(function isSelected2(ele) {
    return ele.selected();
  }, "isSelected");
  var getShadowRoot = __name(function getShadowRoot2(element3) {
    var rootNode = element3.getRootNode();
    if (rootNode && rootNode.nodeType === 11 && rootNode.host !== void 0) {
      return rootNode;
    }
  }, "getShadowRoot");
  var triggerEvents = __name(function triggerEvents2(target, names, e, position3) {
    if (target == null) {
      target = r.cy;
    }
    for (var i2 = 0; i2 < names.length; i2++) {
  ...
  var isMultSelKeyDown = __name(function isMultSelKeyDown2(e) {
    return e.shiftKey || e.metaKey || e.ctrlKey;
  }, "isMultSelKeyDown");
  var allowPanningPassthrough = __name(function allowPanningPassthrough2(down, downs) {
  ...
  var setGrabbed = __name(function setGrabbed2(ele) {
    ele[0]._private.grabbed = true;
  }, "setGrabbed");
  var setFreed = __name(function setFreed2(ele) {
    ele[0]._private.grabbed = false;
  }, "setFreed");
  var setInDragLayer = __name(function setInDragLayer2(ele) {
    ele[0]._private.rscratch.inDragLayer = true;
  }, "setInDragLayer");
  var setOutDragLayer = __name(function setOutDragLayer2(ele) {
    ele[0]._private.rscratch.inDragLayer = false;
  }, "setOutDragLayer");
  var setGrabTarget = __name(function setGrabTarget2(ele) {
    ele[0]._private.rscratch.isGrabTarget = true;
  }, "setGrabTarget");
  var removeGrabTarget = __name(function removeGrabTarget2(ele) {
    ele[0]._private.rscratch.isGrabTarget = false;
  }, "removeGrabTarget");
  var addToDragList = __name(function addToDragList2(ele, opts) {
  ...
  var addDescendantsToDrag = __name(function addDescendantsToDrag2(node, opts) {
  ...
  var addNodesToDrag = __name(function addNodesToDrag2(nodes3, opts) {
    opts = opts || {};
  ...
  var freeDraggedElements = __name(function freeDraggedElements2(grabbedEles) {
    if (!grabbedEles) {
      return;
    }
  ...
  var updateAncestorsInDragLayer = __name(function updateAncestorsInDragLayer2(node, opts) {
    if (opts.inDragLayer == null && opts.addToList == null) {
      return;
    }
    if (!node.cy().hasCompoundNodes()) {
  ...
  var blurActiveDomElement = __name(function blurActiveDomElement2() {
  ...
  var forEachUp = __name(function forEachUp2(domEle, fn3) {
    while (domEle != null) {
      fn3(domEle);
      domEle = domEle.parentNode;
    }
  }, "forEachUp");
  var invalidateCoords = __name(function invalidateCoords2() {
  ...
  var inBoxSelection = __name(function inBoxSelection2() {
    return r.selection[4] !== 0;
  }, "inBoxSelection");
  var eventInContainer = __name(function eventInContainer2(e) {
  ...
  r.registerBinding(r.container, "mousedown", __name(function mousedownHandler(e) {
    ...
    var makeEvent = __name(function makeEvent2(type) {
      return {
        originalEvent: e,
        type,
        position: {
    ...
    var checkForTaphold = __name(function checkForTaphold2() {
      ...
      }
      {
        if (near != null) {
          if (r.nodeIsGrabbable(near)) {
            var triggerGrab = __name(function triggerGrab2(ele) {
  ...
  r.registerBinding([containerWindow, shadowRoot], "mousemove", __name(function mousemoveHandler(e) {
    ...
    var updateDragDelta = __name(function updateDragDelta2() {
    ...
    var goIntoBoxMode = __name(function goIntoBoxMode2() {
  ...
  r.registerBinding(containerWindow, "mouseup", __name(function mouseupHandler(e) {
    ...
    if (r.hoverData.which === 3) {
      ...
      if (r.hoverData.selecting) {
        ...
        var eleWouldBeSelected = __name(function eleWouldBeSelected2(ele) {
  ...
  var allAreDivisibleBy = __name(function allAreDivisibleBy2(list, factor) {
  ...
  var allAreSameMagnitude = __name(function allAreSameMagnitude2(list) {
  ...
  var wheelHandler = __name(function wheelHandler2(e) {
    var clamp = false;
    var delta = e.deltaY;
    if (delta == null) {
  ...
  r.registerBinding(containerWindow, "scroll", __name(function scrollHandler(e) {
  ...
  r.registerBinding(r.container, "gesturestart", __name(function gestureStartHandler(e) {
  ...
  r.registerBinding(r.container, "mouseout", __name(function mouseOutHandler(e) {
    var pos = r.projectIntoViewport(e.clientX, e.clientY);
    r.cy.emit({
      originalEvent: e,
      type: "mouseout",
  ...
  r.registerBinding(r.container, "mouseover", __name(function mouseOverHandler(e) {
    var pos = r.projectIntoViewport(e.clientX, e.clientY);
    r.cy.emit({
      originalEvent: e,
      type: "mouseover",
  ...
  var distance = __name(function distance2(x1, y1, x2, y2) {
    return Math.sqrt((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1));
  }, "distance");
  var distanceSq = __name(function distanceSq2(x1, y1, x2, y2) {
    return (x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1);
  }, "distanceSq");
  var touchstartHandler;
  r.registerBinding(r.container, "touchstart", touchstartHandler = __name(function touchstartHandler2(e) {
  ...
  r.registerBinding(containerWindow, "touchmove", touchmoveHandler = __name(function touchmoveHandler2(e) {
  ...
  r.registerBinding(containerWindow, "touchcancel", touchcancelHandler = __name(function touchcancelHandler2(e) {
    var start = r.touchData.start;
  ...
  r.registerBinding(containerWindow, "touchend", touchendHandler = __name(function touchendHandler2(e) {
    var start = r.touchData.start;
    var capture = r.touchData.capture;
    if (capture) {
  ...
  if (typeof TouchEvent === "undefined") {
    var pointers = [];
    var makeTouch = __name(function makeTouch2(e) {
      return {
        clientX: e.clientX,
        clientY: e.clientY,
        force: 1,
    ...
    var makePointer = __name(function makePointer2(e) {
      return {
        event: e,
        touch: makeTouch(e)
      };
    }, "makePointer");
    var addPointer = __name(function addPointer2(e) {
      pointers.push(makePointer(e));
    }, "addPointer");
    var removePointer = __name(function removePointer2(e) {
    ...
    var updatePointer = __name(function updatePointer2(e) {
    ...
    var addTouchesToEvent = __name(function addTouchesToEvent2(e) {
      e.touches = pointers.map(function(p2) {
        return p2.touch;
      });
    }, "addTouchesToEvent");
    var pointerIsMouse = __name(function pointerIsMouse2(e) {
...
BRp$2.generatePolygon = function(name, points) {
  return this.nodeShapes[name] = {
    ...
    name,
    points,
    draw: __name(function draw(context, centerX, centerY, width2, height2, cornerRadius) {
      this.renderer.nodeShapeImpl("polygon", context, centerX, centerY, width2, height2, this.points);
    }, "draw"),
    intersectLine: __name(function intersectLine(nodeX, nodeY, width2, height2, x2, y2, padding, cornerRadius) {
      return polygonIntersectLine(x2, y2, this.points, nodeX, nodeY, width2 / 2, height2 / 2, padding);
    }, "intersectLine"),
    checkPoint: __name(function checkPoint(x2, y2, padding, width2, height2, centerX, centerY, cornerRadius) {
      return pointInsidePolygon(x2, y2, this.points, centerX, centerY, width2, height2, [0, -1], padding);
    }, "checkPoint"),
    hasMiterBounds: name !== "rectangle",
    miterBounds: __name(function miterBounds(centerX, centerY, width2, height2, strokeWidth, strokePosition) {
...
BRp$2.generateRoundPolygon = function(name, points) {
  return this.nodeShapes[name] = {
    ...
    name,
    points,
    getOrCreateCorners: __name(function getOrCreateCorners(centerX, centerY, width2, height2, cornerRadius, rs, field) {
    ...
    draw: __name(function draw(context, centerX, centerY, width2, height2, cornerRadius, rs) {
    ...
    intersectLine: __name(function intersectLine(nodeX, nodeY, width2, height2, x2, y2, padding, cornerRadius, rs) {
    ...
    checkPoint: __name(function checkPoint(x2, y2, padding, width2, height2, centerX, centerY, cornerRadius, rs) {
...
BRp$2.generateCutRectangle = function() {
  return this.nodeShapes["cut-rectangle"] = this.nodeShapes["cutrectangle"] = {
    ...
    generateCutTrianglePts: __name(function generateCutTrianglePts(width2, height2, centerX, centerY, cornerRadius) {
...
BRp$2.generateBarrel = function() {
  return this.nodeShapes["barrel"] = {
    ...
    intersectLine: __name(function intersectLine(nodeX, nodeY, width2, height2, x2, y2, padding, cornerRadius) {
      ...
      var approximateBarrelCurvePts = __name(function approximateBarrelCurvePts2(pts3) {
        var m0 = qbezierPtAt({
          x: pts3[0],
          y: pts3[1]
        }, {
    ...
    generateBarrelBezierPts: __name(function generateBarrelBezierPts(width2, height2, centerX, centerY) {
      var hh = height2 / 2;
      var hw = width2 / 2;
      var xBegin = centerX - hw;
      var xEnd = centerX + hw;
    ...
    checkPoint: __name(function checkPoint(x2, y2, padding, width2, height2, centerX, centerY, cornerRadius) {
      ...
      var getCurveT = __name(function getCurveT2(x3, y3, curvePts) {
        var x0 = curvePts[4];
        var x1 = curvePts[2];
        var x22 = curvePts[0];
        var y02 = curvePts[5];
...
var beforeRenderCallbacks = __name(function beforeRenderCallbacks2(r, willDraw, startTime) {
...
BRp$1.startRenderLoop = function() {
  ...
  var _renderFn = __name(function renderFn(requestTime) {
    if (r.destroyed) {
      return;
    }
    if (cy.batching()) ;
...
var BaseRenderer = __name(function BaseRenderer2(options2) {
  this.init(options2);
}, "BaseRenderer");
var BR = BaseRenderer;
...
var defs = {
  setupDequeueing: __name(function setupDequeueing(opts) {
    return __name(function setupDequeueingImpl() {
      var self2 = this;
      var r = this.renderer;
      ...
      var dequeue = __name(function dequeue2(willDraw, frameStartTime) {
        var startTime = performanceNow();
...
var ElementTextureCacheLookup = (function() {
  ...
  return _createClass(ElementTextureCacheLookup2, [{
    key: "getIdsFor",
    value: __name(function getIdsFor(key) {
      if (key == null) {
    ...
    key: "addIdForKey",
    value: __name(function addIdForKey(key, id2) {
      if (key != null) {
    ...
    key: "deleteIdForKey",
    value: __name(function deleteIdForKey(key, id2) {
      if (key != null) {
    ...
    value: __name(function getNumberOfIdsForKey(key) {
      if (key == null) {
        return 0;
      } else {
    ...
    value: __name(function updateKeyMappingFor(ele) {
      var id2 = ele.id();
    ...
    value: __name(function deleteKeyMappingFor(ele) {
      var id2 = ele.id();
      var prevKey = this.keyForId.get(id2);
      this.deleteIdForKey(prevKey, id2);
    ...
    value: __name(function keyHasChangedFor(ele) {
      var id2 = ele.id();
      var prevKey = this.keyForId.get(id2);
    ...
    key: "isInvalid",
    value: __name(function isInvalid(ele) {
      return this.keyHasChangedFor(ele) || this.doesEleInvalidateKey(ele);
    }, "isInvalid")
  }, {
    key: "getCachesAt",
    value: __name(function getCachesAt(lvl) {
    ...
    key: "getCache",
    value: __name(function getCache(key, lvl) {
      return this.getCachesAt(lvl).get(key);
    }, "getCache")
  }, {
    key: "get",
    value: __name(function get2(ele, lvl) {
    ...
    key: "getForCachedKey",
    value: __name(function getForCachedKey(ele, lvl) {
    ...
    key: "hasCache",
    value: __name(function hasCache(key, lvl) {
      return this.getCachesAt(lvl).has(key);
    }, "hasCache")
  }, {
    key: "has",
    value: __name(function has(ele, lvl) {
      var key = this.getKey(ele);
      return this.hasCache(key, lvl);
    }, "has")
  }, {
    key: "setCache",
    value: __name(function setCache(key, lvl, cache3) {
      cache3.key = key;
      this.getCachesAt(lvl).set(key, cache3);
    }, "setCache")
  }, {
    key: "set",
    value: __name(function set2(ele, lvl, cache3) {
      var key = this.getKey(ele);
    ...
    key: "deleteCache",
    value: __name(function deleteCache(key, lvl) {
      this.getCachesAt(lvl)["delete"](key);
    }, "deleteCache")
  }, {
    key: "delete",
    value: __name(function _delete(ele, lvl) {
      var key = this.getKey(ele);
      this.deleteCache(key, lvl);
    }, "_delete")
  }, {
    key: "invalidateKey",
    value: __name(function invalidateKey(key) {
      var _this = this;
    ...
    key: "invalidate",
    value: __name(function invalidate(ele) {
      var id2 = ele.id();
...
var ElementTextureCache = __name(function ElementTextureCache2(renderer3, initOptions) {
  var self2 = this;
...
ETCp.getElement = function(ele, bb, pxRatio, lvl, reason) {
  ...
  var addNewTxr = __name(function addNewTxr2() {
  ...
  var scalableFrom = __name(function scalableFrom2(otherCache) {
  ...
  var downscale = __name(function downscale2() {
...
ETCp.setupDequeueing = defs.setupDequeueing({
  ...
  deq: __name(function deq(self2, pxRatio, extent2) {
    return self2.dequeue(pxRatio, extent2);
  }, "deq"),
  onDeqd: __name(function onDeqd(self2, deqd) {
    for (var i2 = 0; i2 < self2.onDequeues.length; i2++) {
      var fn3 = self2.onDequeues[i2];
      fn3(deqd);
    }
  }, "onDeqd"),
  shouldRedraw: __name(function shouldRedraw(self2, deqd, pxRatio, extent2) {
  ...
  priority: __name(function priority(self2) {
...
var LayeredTextureCache = __name(function LayeredTextureCache2(renderer3) {
  var self2 = this;
  ...
  var qSort = __name(function qSort2(a, b) {
    return b.reqs - a.reqs;
  }, "qSort");
...
LTCp.getLayers = function(eles, pxRatio, lvl) {
  ...
  var tmpLayers;
  var checkTempLevels = __name(function checkTempLevels2() {
    var canUseAsTmpLvl = __name(function canUseAsTmpLvl2(l) {
    ...
    var checkLvls = __name(function checkLvls2(dir) {
      if (tmpLayers) {
        return;
      }
    ...
    checkLvls(1);
    checkLvls(-1);
    for (var i22 = layers.length - 1; i22 >= 0; i22--) {
      var layer2 = layers[i22];
      if (layer2.invalid) {
  ...
  var getBb = __name(function getBb2() {
    if (!bb) {
      bb = makeBoundingBox();
      for (var i22 = 0; i22 < eles.length; i22++) {
        updateBoundingBox(bb, eles[i22].boundingBox());
      }
    }
    return bb;
  }, "getBb");
  var makeLayer = __name(function makeLayer2(opts) {
    opts = opts || {};
...
LTCp.invalidateElements = function(eles) {
  ...
  self2.updateElementsInLayers(eles, __name(function invalAssocLayers(layer, ele, req) {
...
LTCp.refineElementTextures = function(eles) {
  var self2 = this;
  self2.updateElementsInLayers(eles, __name(function refineEachEle(layer, ele, req) {
...
LTCp.setupDequeueing = defs.setupDequeueing({
  ...
  deqNoDrawCost,
  deqFastCost,
  deq: __name(function deq2(self2, pxRatio) {
    return self2.dequeue(pxRatio);
  }, "deq"),
  onDeqd: noop$1,
  shouldRedraw: trueify,
  priority: __name(function priority2(self2) {
...
var getZeroRotation = __name(function getZeroRotation2() {
  return 0;
}, "getZeroRotation");
var getLabelRotation = __name(function getLabelRotation2(r, ele) {
  return r.getTextAngle(ele, null);
}, "getLabelRotation");
var getSourceLabelRotation = __name(function getSourceLabelRotation2(r, ele) {
  return r.getTextAngle(ele, "source");
}, "getSourceLabelRotation");
var getTargetLabelRotation = __name(function getTargetLabelRotation2(r, ele) {
  return r.getTextAngle(ele, "target");
}, "getTargetLabelRotation");
var getOpacity = __name(function getOpacity2(r, ele) {
  return ele.effectiveOpacity();
}, "getOpacity");
var getTextOpacity = __name(function getTextOpacity2(e, ele) {
...
CRp$9.drawEdge = function(context, edge, shiftToOriginWithBb) {
  ...
  var drawLine = __name(function drawLine2() {
  ...
  var drawLineOutline = __name(function drawLineOutline2() {
    var strokeOpacity = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : effectiveLineOpacity;
  ...
  var drawOverlay = __name(function drawOverlay2() {
    if (!shouldDrawOverlay) {
      return;
    }
    r.drawEdgeOverlay(context, edge);
  }, "drawOverlay");
  var drawUnderlay = __name(function drawUnderlay2() {
    if (!shouldDrawOverlay) {
      return;
    }
    r.drawEdgeUnderlay(context, edge);
  }, "drawUnderlay");
  var drawArrows = __name(function drawArrows2() {
    var arrowOpacity = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : effectiveArrowOpacity;
    r.drawArrowheads(context, edge, arrowOpacity);
  }, "drawArrows");
  var drawText = __name(function drawText2() {
...
var drawEdgeOverlayUnderlay = __name(function drawEdgeOverlayUnderlay2(overlayOrUnderlay) {
...
CRp$6.drawNode = function(context, node, shiftToOriginWithBb) {
  ...
  var drawShape = __name(function drawShape2() {
    if (!pathCacheHit) {
      var npos = pos;
      if (usePaths) {
        npos = {
  ...
  var drawImages = __name(function drawImages2() {
  ...
  var drawPie = __name(function drawPie2() {
  ...
  var drawStripe = __name(function drawStripe2() {
    var redrawShape = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
  ...
  var darken = __name(function darken2() {
  ...
  var drawBorder = __name(function drawBorder2() {
    if (borderWidth > 0) {
  ...
  var drawOutline = __name(function drawOutline2() {
    if (outlineWidth > 0) {
...
var drawNodeOverlayUnderlay = __name(function drawNodeOverlayUnderlay2(overlayOrUnderlay) {
  if (!["overlay", "underlay"].includes(overlayOrUnderlay)) {
    throw new Error("Invalid state");
  }
...
CRp$5.render = function(options2) {
  ...
  if (motionBlur && mbPxRatio !== 1) {
    ...
    var drawMotionBlur = __name(function drawMotionBlur2(cxt2, txt, needClear) {
...
function createBufferDynamicDraw(gl, instances, type, attributeLoc) {
  ...
  buffer.size = size3;
  buffer.getView = function(i22) {
    return views[i22];
  };
  buffer.setPoint = function(i22, x2, y2) {
    var view = views[i22];
    view[0] = x2;
    view[1] = y2;
  };
...
function create3x3MatrixBufferDynamicDraw(gl, instances, attributeLoc) {
  ...
  gl.bindBuffer(gl.ARRAY_BUFFER, null);
  buffer.getMatrixView = function(i22) {
    return matrixViews[i22];
  };
  buffer.setData = function(matrix, i22) {
    matrixViews[i22].set(matrix, 0);
  };
...
var Atlas = (function() {
  ...
  return _createClass(Atlas2, [{
    key: "lock",
    value: __name(function lock() {
      this.locked = true;
    }, "lock")
  }, {
    key: "getKeys",
    value: __name(function getKeys() {
      return new Set(this.keyToLocation.keys());
    }, "getKeys")
  }, {
    key: "getScale",
    value: __name(function getScale(_ref) {
    ...
    key: "draw",
    value: __name(function draw(key, bb, doDrawing) {
      var _this = this;
      ...
      var drawAt = __name(function drawAt2(location, canvas) {
        if (doDrawing && canvas) {
      ...
      var drawNormal = __name(function drawNormal2() {
      ...
      var drawWrapped = __name(function drawWrapped2() {
      ...
      var moveToStartOfNextRow = __name(function moveToStartOfNextRow2() {
        _this.freePointer.x = 0;
        _this.freePointer.row++;
    ...
    key: "getOffsets",
    value: __name(function getOffsets(key) {
      return this.keyToLocation.get(key);
    }, "getOffsets")
  }, {
    key: "isEmpty",
    value: __name(function isEmpty() {
      return this.freePointer.x === 0 && this.freePointer.row === 0;
    }, "isEmpty")
  }, {
    key: "canFit",
    value: __name(function canFit(bb) {
    ...
    key: "bufferIfNeeded",
    value: __name(function bufferIfNeeded(gl) {
      if (!this.texture) {
...
var AtlasCollection = (function() {
  ...
  return _createClass(AtlasCollection2, [{
    ...
    key: "_createAtlas",
    value: __name(function _createAtlas() {
    ...
    value: __name(function _getScratchCanvas() {
      if (!this.scratch) {
        var r = this.r, texSize = this.texSize, texRows = this.texRows, createTextureCanvas2 = this.createTextureCanvas;
    ...
    key: "getAtlas",
    value: __name(function getAtlas(key) {
      return this.styleKeyToAtlas.get(key);
    }, "getAtlas")
  }, {
    key: "hasAtlas",
    value: __name(function hasAtlas(key) {
      return this.styleKeyToAtlas.has(key);
    }, "hasAtlas")
  }, {
    key: "markKeyForGC",
    value: __name(function markKeyForGC(key) {
      this.markedKeys.add(key);
    }, "markKeyForGC")
  }, {
    key: "gc",
    value: __name(function gc2() {
      var _this2 = this;
    ...
    value: __name(function _copyTextureToNewAtlas(key, oldAtlas, newAtlas) {
    ...
    key: "getCounts",
    value: __name(function getCounts() {
      return {
...
var AtlasManager = (function() {
  ...
  return _createClass(AtlasManager2, [{
    key: "getAtlasSize",
    value: __name(function getAtlasSize() {
      return this.atlasSize;
    }, "getAtlasSize")
  }, {
    key: "addAtlasCollection",
    value: __name(function addAtlasCollection(collectionName, atlasCollectionOptions) {
    ...
    key: "addRenderType",
    value: __name(function addRenderType(type, renderTypeOptions) {
    ...
    value: __name(function getRenderTypeOpts(type) {
      return this.renderTypes.get(type);
    }, "getRenderTypeOpts")
  }, {
    key: "getAtlasCollection",
    value: __name(function getAtlasCollection(name) {
      return this.collections.get(name);
    }, "getAtlasCollection")
  }, {
    key: "_cacheScratchCanvas",
    value: __name(function _cacheScratchCanvas(createTextureCanvas2) {
      var prevW = -1;
      var prevH = -1;
    ...
    value: __name(function getOrCreateAtlas(ele, type, bb, styleKey) {
    ...
    key: "getAtlasInfo",
    value: __name(function getAtlasInfo(ele, type) {
      var _this4 = this;
      var opts = this.renderTypes.get(type);
      var key = opts.getKey(ele);
      var keyArray = Array.isArray(key) ? key : [key];
    ...
    key: "getDebugInfo",
    value: __name(function getDebugInfo() {
      var debugInfo = [];
...
var AtlasBatchManager = (function() {
  ...
  return _createClass(AtlasBatchManager2, [{
    ...
    value: __name(function getMaxAtlasesPerBatch() {
    ...
    key: "getIndexArray",
    value: __name(function getIndexArray() {
      return Array.from({
    ...
    key: "startBatch",
    value: __name(function startBatch2() {
      this.batchAtlases = [];
    }, "startBatch")
  }, {
    key: "getAtlasCount",
    value: __name(function getAtlasCount() {
      return this.batchAtlases.length;
    }, "getAtlasCount")
  }, {
    key: "getAtlases",
    value: __name(function getAtlases() {
      return this.batchAtlases;
    }, "getAtlases")
  }, {
    key: "canAddToCurrentBatch",
    value: __name(function canAddToCurrentBatch(atlas) {
    ...
    value: __name(function getAtlasIndexForBatch(atlas) {
...
var ElementDrawingWebGL = (function() {
  ...
  return _createClass(ElementDrawingWebGL2, [{
    key: "addAtlasCollection",
    value: __name(function addAtlasCollection(collectionName, opts) {
    ...
    value: __name(function addTextureAtlasRenderType(typeName, opts) {
    ...
    */
    ...
    value: __name(function addSimpleShapeRenderType(typeName, opts) {
    ...
    value: __name(function invalidate(eles) {
      ...
      if (type) {
        return atlasManager.invalidate(eles, {
          filterType: __name(function filterType(t) {
            return t === type;
          }, "filterType"),
          forceRedraw: true
        });
    ...
    value: __name(function _createShaderProgram(renderTarget) {
      var gl = this.gl;
      ...
      var fragmentShaderSource = "#version 300 es\n      precision highp float;\n\n      // declare texture unit for each texture atlas in the batch\n      ".concat(idxs.map(function(i22) {
        return "uniform sampler2D uTexture".concat(i22, ";");
        ...
        return "if(vAtlasId == ".concat(i22, ") outColor = texture(uTexture").concat(i22, ", vTexCoord);");
    ...
    key: "_createVAO",
    value: __name(function _createVAO() {
    ...
    key: "startFrame",
    value: __name(function startFrame(panZoomMatrix) {
    ...
    key: "endFrame",
    value: __name(function endFrame() {
      this.endBatch();
    }, "endFrame")
  }, {
    key: "_isVisible",
    value: __name(function _isVisible(ele, opts) {
      if (ele.visible()) {
    ...
    key: "drawTexture",
    value: __name(function drawTexture(ele, eleIndex, type) {
    ...
    value: __name(function setTransformMatrix(ele, matrix, opts, atlasInfo) {
    ...
    value: __name(function _applyTransformMatrix(matrix, adjBB, opts, ele) {
      var x2, y2;
      identity2(matrix);
    ...
    key: "_getAdjustedBB",
    value: __name(function _getAdjustedBB(bb, padding, first2, ratio) {
    ...
    value: __name(function drawPickingRectangle(ele, eleIndex, type) {
    ...
    key: "drawNode",
    value: __name(function drawNode(node, eleIndex, type) {
    ...
    value: __name(function _getVertTypeForShape(node, shapeProp) {
    ...
    value: __name(function _getCornerRadius(node, radiusProp, _ref2) {
    ...
    key: "drawEdgeArrow",
    value: __name(function drawEdgeArrow(edge, eleIndex, prefix) {
      if (!edge.visible()) {
        return;
      }
      var rs = edge._private.rscratch;
    ...
    key: "drawEdgeLine",
    value: __name(function drawEdgeLine(edge, eleIndex) {
      if (!edge.visible()) {
        return;
      }
    ...
    key: "_isValidEdge",
    value: __name(function _isValidEdge(edge) {
      var rs = edge._private.rscratch;
      if (rs.badLine || rs.allpts == null || isNaN(rs.allpts[0])) {
        return false;
      }
    ...
    key: "_getEdgePoints",
    value: __name(function _getEdgePoints(edge) {
      var rs = edge._private.rscratch;
    ...
    key: "_getNumSegments",
    value: __name(function _getNumSegments(edge) {
      var numSegments = 15;
      return Math.min(Math.max(numSegments, 5), this.maxInstances);
    }, "_getNumSegments")
  }, {
    key: "_getCurveSegmentPoints",
    value: __name(function _getCurveSegmentPoints(controlPoints3, segments) {
      if (controlPoints3.length == 4) {
        return controlPoints3;
      }
    ...
    key: "_setCurvePoint",
    value: __name(function _setCurvePoint(points, t, curvePoints, cpi) {
      if (points.length <= 2) {
    ...
    key: "endBatch",
    value: __name(function endBatch2() {
...
CRp$4.initWebgl = function(opts, fns) {
  ...
  var getLabelRotation3 = __name(function getLabelRotation4(prop) {
    return function(ele) {
      return r.getTextAngle(ele, prop);
    };
  }, "getLabelRotation");
  var isLabelVisible = __name(function isLabelVisible2(prop) {
    return function(ele) {
      var label = ele.pstyle(prop);
      return label && label.value;
    };
  }, "isLabelVisible");
  var isLayerVisible = __name(function isLayerVisible2(prefix) {
    return function(node) {
      return node.pstyle("".concat(prefix, "-opacity")).value > 0;
    };
  }, "isLayerVisible");
  var getTexPickingMode = __name(function getTexPickingMode2(ele) {
    var enabled = ele.pstyle("text-events").strValue === "yes";
    return enabled ? TEX_PICKING_MODE.USE_BB : TEX_PICKING_MODE.IGNORE;
  }, "getTexPickingMode");
  var getBBForSimpleShape = __name(function getBBForSimpleShape2(node) {
...
var getStyleKeysForLabel = __name(function getStyleKeysForLabel2(getKey3, prefix) {
  return function(ele) {
    var key = getKey3(ele);
...
var getBoundingBoxForLabel = __name(function getBoundingBoxForLabel2(getBoundingBox, prefix) {
...
function clearCanvas(r) {
  var clear = __name(function clear2(context) {
    context.save();
    context.setTransform(1, 0, 0, 1, 0, 0);
    context.clearRect(0, 0, r.canvasWidth, r.canvasHeight);
    context.restore();
...
function drawAtlases(r) {
  var draw = __name(function draw2(drawing, name, row) {
...
function output(options2, canvas, mimeType) {
  var getB64Uri = __name(function getB64Uri2() {
...
function CanvasRenderer(options2) {
  ...
  var getBoxCenter = __name(function getBoxCenter2(bb) {
    return {
      x: (bb.x1 + bb.x2) / 2,
      y: (bb.y1 + bb.y2) / 2
    };
  }, "getBoxCenter");
  var getCenterOffset = __name(function getCenterOffset2(bb) {
    return {
      x: -bb.w / 2,
      y: -bb.h / 2
    };
  }, "getCenterOffset");
  var backgroundTimestampHasChanged = __name(function backgroundTimestampHasChanged2(ele) {
    var _p = ele[0]._private;
    var same2 = _p.oldBackgroundTimestamp === _p.backgroundTimestamp;
    return !same2;
  }, "backgroundTimestampHasChanged");
  var getStyleKey = __name(function getStyleKey2(ele) {
    return ele[0]._private.nodeKey;
  }, "getStyleKey");
  var getLabelKey = __name(function getLabelKey2(ele) {
    return ele[0]._private.labelStyleKey;
  }, "getLabelKey");
  var getSourceLabelKey = __name(function getSourceLabelKey2(ele) {
    return ele[0]._private.sourceLabelStyleKey;
  }, "getSourceLabelKey");
  var getTargetLabelKey = __name(function getTargetLabelKey2(ele) {
    return ele[0]._private.targetLabelStyleKey;
  }, "getTargetLabelKey");
  var drawElement = __name(function drawElement2(context, ele, bb, scaledLabelShown, useEleOpacity) {
    return r.drawElement(context, ele, bb, false, false, useEleOpacity);
  }, "drawElement");
  var drawLabel = __name(function drawLabel2(context, ele, bb, scaledLabelShown, useEleOpacity) {
    return r.drawElementText(context, ele, bb, scaledLabelShown, "main", useEleOpacity);
  }, "drawLabel");
  var drawSourceLabel = __name(function drawSourceLabel2(context, ele, bb, scaledLabelShown, useEleOpacity) {
    return r.drawElementText(context, ele, bb, scaledLabelShown, "source", useEleOpacity);
  }, "drawSourceLabel");
  var drawTargetLabel = __name(function drawTargetLabel2(context, ele, bb, scaledLabelShown, useEleOpacity) {
    return r.drawElementText(context, ele, bb, scaledLabelShown, "target", useEleOpacity);
  }, "drawTargetLabel");
  var getElementBox = __name(function getElementBox2(ele) {
    ele.boundingBox();
    return ele[0]._private.bodyBounds;
  }, "getElementBox");
  var getLabelBox = __name(function getLabelBox2(ele) {
    ele.boundingBox();
    return ele[0]._private.labelBounds.main || emptyBb;
  }, "getLabelBox");
  var getSourceLabelBox = __name(function getSourceLabelBox2(ele) {
    ele.boundingBox();
    return ele[0]._private.labelBounds.source || emptyBb;
  }, "getSourceLabelBox");
  var getTargetLabelBox = __name(function getTargetLabelBox2(ele) {
    ele.boundingBox();
    return ele[0]._private.labelBounds.target || emptyBb;
  }, "getTargetLabelBox");
  var isLabelVisibleAtScale = __name(function isLabelVisibleAtScale2(ele, scaledLabelShown) {
    return scaledLabelShown;
  }, "isLabelVisibleAtScale");
  var getElementRotationPoint = __name(function getElementRotationPoint2(ele) {
    return getBoxCenter(getElementBox(ele));
  }, "getElementRotationPoint");
  var addTextMargin = __name(function addTextMargin2(prefix, pt, ele) {
  ...
  var getRsPt = __name(function getRsPt2(ele, x2, y2) {
  ...
  var getLabelRotationPoint = __name(function getLabelRotationPoint2(ele) {
    return addTextMargin("", getRsPt(ele, "labelX", "labelY"), ele);
  }, "getLabelRotationPoint");
  var getSourceLabelRotationPoint = __name(function getSourceLabelRotationPoint2(ele) {
    return addTextMargin("source", getRsPt(ele, "sourceLabelX", "sourceLabelY"), ele);
  }, "getSourceLabelRotationPoint");
  var getTargetLabelRotationPoint = __name(function getTargetLabelRotationPoint2(ele) {
    return addTextMargin("target", getRsPt(ele, "targetLabelX", "targetLabelY"), ele);
  }, "getTargetLabelRotationPoint");
  var getElementRotationOffset = __name(function getElementRotationOffset2(ele) {
    return getCenterOffset(getElementBox(ele));
  }, "getElementRotationOffset");
  var getSourceLabelRotationOffset = __name(function getSourceLabelRotationOffset2(ele) {
    return getCenterOffset(getSourceLabelBox(ele));
  }, "getSourceLabelRotationOffset");
  var getTargetLabelRotationOffset = __name(function getTargetLabelRotationOffset2(ele) {
    return getCenterOffset(getTargetLabelBox(ele));
  }, "getTargetLabelRotationOffset");
  var getLabelRotationOffset = __name(function getLabelRotationOffset2(ele) {
  ...
  r.onUpdateEleCalcs(__name(function invalidateTextureCaches(willDraw, eles) {
  ...
  var refineInLayers = __name(function refineInLayers2(reqs) {
    for (var i22 = 0; i22 < reqs.length; i22++) {
      lyrTxrCache.enqueueElementRefinement(reqs[i22].ele);
    }
  }, "refineInLayers");
...
function setExtension(type, name, registrant) {
  var ext = registrant;
  var overrideErr = __name(function overrideErr2(field) {
  ...
  if (type === "core") {
    ...
    var Layout = __name(function Layout2(options2) {
      this.options = options2;
    ...
    var getCy = __name(function getCy2(layout4) {
      return layout4._private.cy;
    }, "getCy");
    var emitterOpts = {
      addEventFields: __name(function addEventFields4(layout4, evt) {
        evt.layout = layout4;
        evt.cy = getCy(layout4);
        evt.target = layout4;
      }, "addEventFields"),
      bubble: __name(function bubble3() {
        return true;
      }, "bubble"),
      parent: __name(function parent4(layout4) {
        return getCy(layout4);
      }, "parent")
    };
    extend(layoutProto, {
      createEmitter: __name(function createEmitter3() {
        this._private.emitter = new Emitter(emitterOpts, this);
        return this;
      }, "createEmitter"),
      emitter: __name(function emitter3() {
        return this._private.emitter;
      }, "emitter"),
      on: __name(function on3(evt, cb) {
        this.emitter().on(evt, cb);
        return this;
      }, "on"),
      one: __name(function one3(evt, cb) {
        this.emitter().one(evt, cb);
        return this;
      }, "one"),
      once: __name(function once3(evt, cb) {
        this.emitter().one(evt, cb);
        return this;
      }, "once"),
      removeListener: __name(function removeListener3(evt, cb) {
        this.emitter().removeListener(evt, cb);
        return this;
      }, "removeListener"),
      removeAllListeners: __name(function removeAllListeners3() {
        this.emitter().removeAllListeners();
        return this;
      }, "removeAllListeners"),
      emit: __name(function emit3(evt, params) {
    ...
    var Renderer = __name(function Renderer2() {
...
var extension = __name(function extension2() {
...
var _Stylesheet = __name(function Stylesheet() {
...
var version = "3.33.1";
var cytoscape = __name(function cytoscape2(options2) {
  if (options2 === void 0) {
    options2 = {};
  }
  if (plainObject(options2)) {
...
//# sourceMappingURL=chunk-Z4HNZR3K.js.map

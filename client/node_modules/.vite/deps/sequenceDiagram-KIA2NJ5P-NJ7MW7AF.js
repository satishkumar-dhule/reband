...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/sequenceDiagram-KIA2NJ5P.mjs
var parser = (function() {
...
var draw = __name(async function(_text, id, _version, diagObj) {
  ...
  const diagram2 = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : select_default2(`[id="${id}"]`);
  const actors = diagObj.db.getActors();
...
//# sourceMappingURL=sequenceDiagram-KIA2NJ5P-NJ7MW7AF.js.map

...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/diagram-KMU2TTTP.mjs
var TreeMapDB = class {
  constructor() {
    this.nodes = [];
...
var draw = __name((_text, id, _version, diagram2) => {
  ...
  try {
    ...
    if (formatStr === "$0,0") {
      valueFormat = __name((value) => "$" + format2(",")(value), "valueFormat");
    } else if (formatStr.startsWith("$") && formatStr.includes(",")) {
      const precision = /\.\d+/.exec(formatStr);
      const precisionStr = precision ? precision[0] : "";
      valueFormat = __name((value) => "$" + format2("," + precisionStr)(value), "valueFormat");
    } else if (formatStr.startsWith("$")) {
      const restOfFormat = formatStr.substring(1);
      valueFormat = __name((value) => "$" + format2(restOfFormat || "")(value), "valueFormat");
    } else {
...
//# sourceMappingURL=diagram-KMU2TTTP-SGEBGXUL.js.map

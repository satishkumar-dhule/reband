...
// node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.esm/chunk-UKMXQNCB.mjs
...
var Channel = {
  ...
  clamp: {
    r: __name((r) => r >= 255 ? 255 : r < 0 ? 0 : r, "r"),
    g: __name((g) => g >= 255 ? 255 : g < 0 ? 0 : g, "g"),
    b: __name((b) => b >= 255 ? 255 : b < 0 ? 0 : b, "b"),
    h: __name((h) => h % 360, "h"),
    s: __name((s) => s >= 100 ? 100 : s < 0 ? 0 : s, "s"),
    l: __name((l) => l >= 100 ? 100 : l < 0 ? 0 : l, "l"),
    a: __name((a) => a >= 1 ? 1 : a < 0 ? 0 : a, "a")
  },
  /* CONVERSION */
...
var Lang = {
  /* API */
  clamp: __name((number, lower, upper) => {
    if (lower > upper)
...
var change = __name((color, channels2) => {
...
var mix = __name((color1, color2, weight = 50) => {
...
var mix_default = mix;
var invert = __name((color, weight = 100) => {
...
if (!freeze) {
  freeze = __name(function freeze2(x) {
    return x;
  }, "freeze");
}
if (!seal) {
  seal = __name(function seal2(x) {
    return x;
  }, "seal");
}
if (!apply) {
  apply = __name(function apply2(func, thisArg) {
...
if (!construct) {
  construct = __name(function construct2(Func) {
...
var getGlobal = __name(function getGlobal2() {
  return typeof window === "undefined" ? null : window;
}, "getGlobal");
var _createTrustedTypesPolicy = __name(function _createTrustedTypesPolicy2(trustedTypes, purifyHostElement) {
...
var _createHooksMap = __name(function _createHooksMap2() {
  return {
...
function createDOMPurify() {
  ...
  const DOMPurify = __name((root) => createDOMPurify(root), "DOMPurify");
  ...
  const isRegexOrFunction = __name(function isRegexOrFunction2(testValue) {
    return testValue instanceof RegExp || testValue instanceof Function;
  }, "isRegexOrFunction");
  const _parseConfig = __name(function _parseConfig2() {
  ...
  const _checkValidNamespace = __name(function _checkValidNamespace2(element) {
  ...
  const _forceRemove = __name(function _forceRemove2(node) {
  ...
  const _removeAttribute = __name(function _removeAttribute2(name, element) {
    try {
      arrayPush(DOMPurify.removed, {
  ...
  const _initDocument = __name(function _initDocument2(dirty) {
    let doc = null;
  ...
  const _createNodeIterator = __name(function _createNodeIterator2(root) {
  ...
  const _isClobbered = __name(function _isClobbered2(element) {
    return element instanceof HTMLFormElement && (typeof element.nodeName !== "string" || typeof element.textContent !== "string" || typeof element.removeChild !== "function" || !(element.attributes instanceof NamedNodeMap) || typeof element.removeAttribute !== "function" || typeof element.setAttribute !== "function" || typeof element.namespaceURI !== "string" || typeof element.insertBefore !== "function" || typeof element.hasChildNodes !== "function");
  }, "_isClobbered");
  const _isNode = __name(function _isNode2(value) {
  ...
  const _sanitizeElements = __name(function _sanitizeElements2(currentNode) {
    let content = null;
  ...
  const _isValidAttribute = __name(function _isValidAttribute2(lcTag, lcName, value) {
  ...
  const _isBasicCustomElement = __name(function _isBasicCustomElement2(tagName) {
    return tagName !== "annotation-xml" && stringMatch(tagName, CUSTOM_ELEMENT2);
  }, "_isBasicCustomElement");
  const _sanitizeAttributes = __name(function _sanitizeAttributes2(currentNode) {
  ...
  const _sanitizeShadowDOM = __name(function _sanitizeShadowDOM2(fragment) {
    let shadowNode = null;
...
var renderKatexUnsanitized = __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-CFV4PT7P-DTOOUFIJ.js");
...
//# sourceMappingURL=chunk-KT5MN6BN.js.map

        ...
        >
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xl text-[#8b949e]">Master technical interviews with AI-powered practice</p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <div>
                ...
                <p className="text-lg text-[#8b949e]">Continue your interview preparation journey</p>
              </div>
        ...
        <div className="space-y-12">
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { title: 'Voice Interview', desc: 'Practice speaking', icon: Mic, color: 'bg-[#1f6feb]', path: '/voice-interview' },
                { title: 'Coding Challenge', desc: 'Solve problems', icon: Code, color: 'bg-[#238636]', path: '/coding' },
                { title: 'Training Mode', desc: 'Structured learning', icon: Target, color: 'bg-[#da3633]', path: '/training' },
                { title: 'Quick Tests', desc: 'Rapid checks', icon: Zap, color: 'bg-[#d29922]', path: '/tests' }
              ].map((action, i) => (
                <motion.button
                  key={i}
                  initial={{ opacity: 0, y: 20 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <section className="p-8 bg-[#161b22] border border-[#30363d] rounded-xl">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => setLocation('/learning-paths')} className="text-sm text-[#58a6ff] hover:underline">
                  View All
                </button>
              </div>

# DevPrep GitHub Theme Colors Expert
# Specialized agent for GitHub color system and dark mode

export const devprepThemeColorsExpert = {
  id: 'devprep-github-colors-expert',
  name: 'GitHub Colors Expert',
...
export default devprepThemeColorsExpert;

# DevPrep GitHub Typography Expert
# Specialized agent for GitHub typography system

export const devprepGithubTypographyExpert = {
  id: 'devprep-github-typography-expert',
  name: 'GitHub Typography Expert',
...
export default devprepGithubTypographyExpert;

...
**Note**: Follow GitHub Actions workflow error handling best practices from official documentation at https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions
